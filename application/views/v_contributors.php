...
<div class="clsContributors " style="width:90%;" >
						...
						<?php /*?><div style="float:left;"><?php echo $this->lang->line('txt_Contributors');?>					
						 ...
						 : </div> 	
						  ...
						  <div style="float:left; " id='divContributors'>&nbsp;<?php echo implode(', ',$contributorsTagName);?></div><?php */?>
							...
							<div class="vContributors" id="vContributors" style="margin-bottom:15px; font-size: 1em; width: 100%;"  >
							<?php
				...
				<div id="edit_notes" class="<?php echo $seedBgColor;?>" style="width:90%;float:left;" >
					...
					?>
                        ...
                        <form name="frmedit_notes" id="frmedit_notes" method="post" action="<?php echo base_url();?>notes/Edit_Notes/<?php echo $workSpaceId;?>/<?php echo $workSpaceType;?>">


						<input value="<?php echo $contributorsList ?>" id="contributorslist" type="hidden" name="contributorslist" />
                      

						<input type="text" id="showMembers" name="showMembers" onKeyUp="showSearchContributors('<?php echo $treeId; ?>')"/> 
                       ...
                       <?php echo $members;?>
                        ...
                        <input name="editNotes" type="button"  onclick="editContributorsNew()" value="<?php echo $this->lang->line('txt_Apply');?>" class="button01"> 
