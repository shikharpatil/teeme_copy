...
<div class="postHeadingBox">
  ...
  <div style="float:left;">
							<?php
								...
								{
							?>
									<img src="<?php echo base_url();?>workplaces/<?php echo $workPlaceDetails['companyName'];?>/user_profile_pics/<?php echo $TimelineProfiledetail['photo'];?>" border="0"  width="35" height="35" id="imgName" style="margin-top:0px;"> 
                          	<?php
								}
								else
								{
							?>
									<img src="<?php echo base_url();?>images/<?php echo $TimelineProfiledetail['photo'];?>" border="0"  width="35" height="35" id="imgName" style="margin-top:0px;"> 
							<?php
								}
							?>
	</div>
