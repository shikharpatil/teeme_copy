...

		{
                    ...
                    <table width="80%" border="0" cellpadding="3" cellspacing="0" bordercolor="#111111" class="text_gre1" id="table12" style="border-collapse: collapse;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="205" align="right" valign="middle" class="text_gre1"><?php echo $this->lang->line('subspace_name_txt'); ?> </td>

                          <td width="5" align="center" valign="middle" class="text_gre"><strong>:</strong></td>

                          <td width="485" align="left" class="text_gre">

                            <input name="workSpaceName" class="text_gre1" id="workSpaceName" size="30" value="<?php echo $subWorkSpaceDetails['subWorkSpaceName'];?>">
            ...
            &nbsp;<span id="workPlaceStatusText"></span> </td>
                       ...
                       <tr>
                         ...
                         <td align="right" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Add_SubWorkspace_Members');?></td>
                         ...
                         <td align="left" class="text_gre">
							<div style="width:410px;">
								...
								?>
									...
									<span <?php if(!(in_array('3',$treeTypeIds))) { ?> style="display:none;" <?php } ?> style="float:left;"><input <?php if(in_array('3',$treeTypeIds)) { echo 'checked'; } ?> type="checkbox" class="spaceTreeCls" name="spaceTreeOptions[]" value="3" /><?php echo $this->lang->line('txt_Discuss');?></span>
									...
									<span <?php if(!(in_array('3',$treeTypeIds))) { ?> style="display:block; float:left;" <?php }  else { ?> style="display:none;" <?php } ?>><input type="checkbox" class="spaceTreeCls" name="spaceTreeOptions[]" value="3" /><?php echo $this->lang->line('txt_Discuss');?> </span>
