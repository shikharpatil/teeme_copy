...
<div>
    ...
    <ul class="tab_menu_new">
        ...
        <li>
            ...
            <a href="javascript:void(0);" id="profile" style="padding-left:5px;margin-left:17px;" title="profile" class="<?php if($profileForm=='1' && $passwordForm!='1'){ ?> active <?php } ?>" onclick="$('#profile').addClass('active');$('#passwordForm').removeClass('active');$('#notification').removeClass('active');$('#password_form').hide();$('#notificationSection').hide();$('#profileForm').show(); clearSessionMsg();"><?php echo $this->lang->line('profile_txt'); ?></a>

        </li>
		<!--profile tab end here-->
		 <li>

            <a href="javascript:void(0);" id="passwordForm" style="padding-left:5px;margin-left:17px;" title="password" class="<?php if($passwordForm=='1'){ ?> active <?php } ?>" onclick="$('#passwordForm').addClass('active');$('#profile').removeClass('active');$('#notification').removeClass('active');$('#profileForm').hide();$('#notificationSection').hide();$('#password_form').show(); clearSessionMsg();"><?php echo $this->lang->line('txt_Password'); ?></a>
   ...
   <?php /*?> <div style="padding-left:6%;padding-top:1%;width:100%;color:red;"><?php echo $_SESSION['errorMsg'];unset($_SESSION['errorMsg']);?></div>
          ...
          <div id="workPlaceDiv" style="padding-left:0%; margin-top:1%;">
			...
			<td style="padding-bottom:20px;">
				<?php
							...
							?>
			  <div>
              	<input type="file" name="photo" id="photo" class="text_gre1" size="22" onchange="readURL(this);" onclick="clearSessionMsg();" style="word-wrap:break-word; width:100%;" />
			  </div>        
              <div>(jpg, jpeg, png, gif only) </div>
			  <span class="errorMsg photoErrorMsg" style="color:red;"><?php echo $_SESSION['errorMsg'];unset($_SESSION['errorMsg']);?></span>
			</td>
			</tr>
			<tr>
			<td style="padding-bottom:20px;" class="profileLeftLabel">
			...
			<td style="padding-bottom:20px;">
				<input class="text_gre1" size="22" value="<?php echo $Profiledetail['firstName'].' '.$Profiledetail['lastName']; ?>" readonly="" style="background:#ccc;"/>
			</td>
			</tr>
			<tr>
			<td style="padding-bottom:20px;" class="profileLeftLabel">
			...
			<td style="padding-bottom:20px;">
				<input name="nickName" class="text_gre1" id="nickName" size="22" value="<?php echo $Profiledetail['editNickName'];?>"/>
			</td>
			</tr>
			<tr>
				<td style="padding-bottom:20px;" class="profileLeftLabel">
				...
				<td style="padding-bottom:20px;">
					 <textarea name="status" id="statusUpdate" style="width:100%; min-height: 65px; max-height: 65px; height: 65px;"><?php echo $Profiledetail['statusUpdate'];?></textarea>
				</td>
				</tr>
			<tr>
			<td style="padding-bottom:20px;" class="profileLeftLabel">	
			...
			<td style="padding-bottom:20px;">
					<input name="role" class="text_gre1" id="role" size="22"  value="<?php echo $Profiledetail['role'];?>"/>
			</td>
			</tr>
			<tr> 
				<td style="padding-bottom:20px;" class="profileLeftLabel">
				...
				<td style="padding-bottom:20px;">
					 <input name="mobile" class="text_gre1" id="mobile" size="22" value="<?php echo $Profiledetail['mobile'];?>"/>
			</td>
			</tr>
			<tr>
			<td style="padding-bottom:20px;" class="profileLeftLabel">
			...
			<td style="padding-bottom:20px;">
				<input class="text_gre1"  size="22" value="<?php echo $Profiledetail['userName'];?>" readonly="" style="background:#ccc;"/>
			</td>
			</tr>
			<tr>
			...
			<td style="">
				<input class="text_gre1" size="22" value="<?php echo $Profiledetail['editUserTagName'];?>" readonly="" style="background:#ccc;"/>
			</td>
			</tr>
			<tr>
			</tr>
    ...
    ?>
            ...
            <div style=" width:100%; margin-top:10px; float:left; margin-left:0px ">
             ...
             <input type="hidden" name="workSpaceType" class="hidden" id="workSpaceType" size="30" value="<?php echo $workSpaceType;?>"/>
			  ...
			  <input type="reset" name="Cancel" value="<?php echo $this->lang->line('txt_Cancel');?>" class="button01" onclick="clearProfileForm()"/>
			   ...
			   <span class="successMsg" style="margin-left:0px; margin-bottom:10px; font-size:0.9em;"><?php echo $_SESSION['successMsg'];unset($_SESSION['successMsg']);?></span>
    ...
    ?>
			...
			<!--Third section start here-->
			<div class="ThirdDiv" style="width:100%; margin-top:10px;">
			...
			<td style="padding-bottom:10px;">
              <input name="currentPassword" type="password" class="text_gre1" id="currentPassword" size="13" />
           ...
           <?php echo $this->lang->line('txt_New_Password');?>:
			...
			<td style="padding-bottom:10px;">
              ...
              <input name="password" type="password" class="text_gre1" id="password" size="13" />
			...
			<td>
              ...
              <input name="confirmPassword" type="password" class="text_gre1" id="confirmPassword" size="13" />
            ...
            <div style=" width:<?php echo ($this->config->item('page_width')/10)-28;?>%; margin-top:10px; float:left; margin-left:8px ">
	...
	<div class="successMsg" style="margin-left:0px; margin-bottom:10px;"><?php echo $_SESSION['preferenceSuccessMsg'];unset($_SESSION['preferenceSuccessMsg']);?></div>
		...
		<div class="emailNotification">
          ...
          <select name="spaceSelect" class="selbox-min" style="padding:0px; margin:0px; width:150px !important; height:23px;" >
    ...
    ?>
			...
			<td style="padding-bottom:10px;">
					...
					<select name="language" style="width:150px !important;">
						<option value="eng" <?php if($languageStatus=='1'){ ?> selected <?php } ?>><?php echo $this->lang->line('txt_english_language'); ?></option>
						<option value="jpn" <?php if($languageStatus=='2'){ ?> selected <?php } ?>><?php echo $this->lang->line('txt_japanese_language'); ?></option>
					</select>
		...
		<!--Timezone section start-->
				...
				<td style="padding-bottom:10px;">
						...
						<select name="timezone" id="timezone" style="width:150px;">
