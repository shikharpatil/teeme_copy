...
<table width="<?php echo $this->config->item('page_width');?>" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D9E3F2">
  <tr>
	...
	?>
      <tr>
      <td  align="left"  class="bg-grey-img"><span class="heading-grey"><a href="<?php echo base_url();?>view_activity/View_All/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/<?php echo $option;?>/1"><?php echo $this->lang->line('txt_Activities');?></a> </span></td>
        ...
        <td class="bg-grey-img"><span class="heading-grey"><a href="<?php echo base_url();?>view_activity/View_All/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/<?php echo $option;?>/4"><?php echo $this->lang->line('txt_Start_Time');?> </a></span></td>
        <td class="bg-grey-img"><span class="heading-grey"><a href="<?php echo base_url();?>view_activity/View_All/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/<?php echo $option;?>/5"><?php echo $this->lang->line('txt_End_Time');?></a> </span></td>
        <td class="bg-grey-img">&nbsp;</td>
      </tr>
	...
	//print_r($arrDiscussions);
      ...
      <tr>
		...
		{		
			echo  $this->time_manager->getUserTimeFromGMTTime($arrVal['starttime'], 'm-d-Y h:i A');
		}
		?></td>
        <td align="left" valign="top"  class="bg-white">
		<?php 
		if($arrEndTime[0] != '00')
		{			
			echo $this->time_manager->getUserTimeFromGMTTime($arrVal['endtime'], 'm-d-Y h:i A');
		}
		?></td>
        <td align="left" valign="top" class="bg-white">&nbsp;</td>
      </tr>
		<?php
		echo form_close();
		}
