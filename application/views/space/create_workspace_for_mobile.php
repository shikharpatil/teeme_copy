				...
				?>					                  
                       ...
                       <tr>
                         ...
                         <td width="485" align="left" class="text_gre">
                           ...
                           <input name="workSpaceName" class="text_gre1" id="workSpaceName" size="20" value=""/>&nbsp;<span id="workPlaceStatusText"></span>
                       ...
                       <tr>
						...
						<input type="checkbox" name="members" value="0"  class="allcheck" id="checkAll"/> <?php echo $this->lang->line('txt_All');?><br />
						 ...
						 <!--Manoj: comment remove start-->
							...
							<div id="showMan" style="max-height:120px; width:300px; overflow:scroll;">
