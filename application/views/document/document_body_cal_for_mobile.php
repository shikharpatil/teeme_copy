...
<div class="<?php echo $nodeBgColor;?> views_div">
  <?php	
  						/*$this->identity_db_manager->formatContent($leafData['contents'],1000,1)*/
						echo '<div style="width:100%;"><a href=view_document/index/'.$workSpaceId.'/type/'.$workSpaceType.'/?treeId='.$treeId.'&doc=exist&node='.$leafData['nodeId1'].'#docLeafContent'.$leafData['nodeId1'].' style="text-decoration:none; color:#000;max-width:95%;float:left;">'.stripslashes($leafData['contents']).'</a></div>';	
					
					echo  "<div class='userLabel' style='width:100%; float:left; margin:5% 0%;'>".$leafData['tagName']."&nbsp;&nbsp;";
