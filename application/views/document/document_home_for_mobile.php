...
<div id="container_for_mobile">
    ...
    <div class="row-active-header"> 
          <!-- Changed By Surbhi IV-->
          <div class="row-active-header-inner1" style="width:60%; padding:0;"> <span class="rowHeaderFont" ><a href="<?php echo base_url();?>document_home/index/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1"><?php echo $this->lang->line('txt_Document');?></a></span> (<?php echo count($arrDocuments); ?>) </div>
		  <!--Manoj: comment for created by text-->
         <?php /*?> <div class="row-active-header-inner2" style="width:38%;"> <span class="rowHeaderFont" ><a href="<?php echo base_url();?>document_home/index/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/2"><?php echo $this->lang->line('txt_Created_By');?></a></span> </div><?php */?>
