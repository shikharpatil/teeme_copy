...
<body>
	...
	<div id="container">
		...
		<div id="rightSideBar">
			<div id="table_view">
				<div>
	                <ul class="tab_menu_new" style="z-index:1000;margin-left:5px;">
	                	<li>
	                	...
	                	<li>
	                		...
	                		<a style="padding:10px 18px;" href="javascript:void(0);" id="tabm2" onclick="$('#TimelineRightContentForTab').hide();$('#onlineUsersForTab').show();$('#tabm1').removeClass('active');$('#tabm2').addClass('active');"><img src="<?php  echo base_url().'images/list_icon.png'; ?>" /></a>
	                    </li>		
	                </ul>
				</div>
				...
				<div>
					<div id="onlineUsersForTab" style="display:none;">
				...
				<div id="TimelineRightContentForTab" style="width:100%;">
						    ...
						    <ul class="tab_menu_new">
								<li>
								    ...
								    <?php 
								  	...
								  	{ ?>
										<a style="padding-left:12px;margin-left:2px;<?php if(!$_SESSION['all'] && $this->uri->segment(8)!='bookmark') { ?>" class="active <?php } ?>" title="<?php echo $workSpaceName ?>"  id="curr" href="<?php echo base_url(); ?>post/index/<?php echo $workSpaceId; ?>/type/<?php echo $workSpaceType; ?>/<?php echo $workSpaceId; ?>/<?php echo $workSpaceType; ?>">
											<span>
	    						...
	    						<ul class="tab_menu_new" style="float:right;">
							        ...
							        <li>
							           <?php /*?> <a href="javascript:void(0);" id="profile" style="padding-left:12px;margin-left:17px;" title="profile" class="<?php if($profileForm=='1' && $passwordForm!='1'){ ?> active <?php } ?>" onclick="$('#profile').addClass('active');$('#passwordForm').removeClass('active');$('#notification').removeClass('active');$('#password_form').hide();$('#notificationSection').hide();$('#profileForm').show(); clearSessionMsg();"><?php echo $this->lang->line('profile_txt'); ?></a><?php */?>
										...
										<?php if ($workSpaceDetails['workSpaceName']!="Try Teeme") 
										{ ?>
							            	<a href="<?php echo base_url(); ?>post/index/<?php echo $workSpaceId; ?>/type/<?php echo $workSpaceType; ?>/0/1/all<?php if($this->uri->segment(10)!=''){ echo '/0/'.$userPostSearch; }?>" style="padding-left:12px;margin-left:17px; <?php if($_SESSION['all']) { ?>" class="active <?php } ?>" id="all"><?php echo $this->lang->line('all_post_txt').' ('.$allPosts.')'; ?>
					...
					<!--Tab section end here-->
  					...
  					<div class="timelineTopContent">
						...
						<div id="TimelineProfile"  style=" display: <?php if($this->uri->segment(10)==''){ echo 'none';}else{ echo 'block';}?> ">
							<div style="float:left; width:90%;">
								...
								<div style="width:90%; float:left;" class="postUserDetailsBox">
									...
									<?php 
									if($Profiledetail['firstName']!='' && $Profiledetail['lastName']!='') 
									{ 
									?>
									...
									<?php 
									if($Profiledetail['editUserTagName']!='') 
									{ 
									?>
										<table class="postTable" style="font-size:0.8em; width:30%;">
											<tr>
						...
						<div id="TimelineEditor" style="width:98%; padding:2% 1%; display:none;" >
