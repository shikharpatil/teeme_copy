...
<div id="container_for_mobile">
  <div id="content"> 
    ...
    <?php
			...
			{
			?>
    <span  class="errorMsg" style="height:30px; margin-top:5px">
	  ...
	  <?php
			...
			{
			?>
	   <span  class="successMsg" style="height:30px; margin-top:5px">
      
      <?php echo $_SESSION['successMsg']; $_SESSION['successMsg'] ='';?>
