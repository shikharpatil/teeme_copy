...
<div id="container" class="contactWrapper">
...
<div id="rightSideBar"> 
    ...
    <!-- <div class="menu_new" >
        ...
        <?php
				...
				?>
        <li id="treeUpdate"></li>
        <li id="treeUpdate" style="float:right;"><img id="updateImage" title="<?php echo $this->lang->line('txt_Update');?>" src="<?php echo base_url()?>images/new-version.png" onclick='window.location="<?php echo base_url()?>contact/contactDetails/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1"' style=" cursor:pointer" ></li>
    ...
    <!-- <div id="divSeed" class="seedBackgroundColorNew"  style="min-height:245px;"  > -->
        ...
        <div id="ulNodesHeader0" class="ulNodesHeader" style="float:right; display:inline; " >
					...
					$opt = $this->identity_db_manager->getManagerStatus($_SESSION['userId'], $workSpaceDetails['workSpaceId'], $workSpaceDetails['workSpaceType']);
						if($opt)
						{
							if ($workSpaceId==0)
							{
								if ($originator['userId']==$_SESSION['userId'])
								{
					?>
							...
							<div style="float:left; margin-right:10px;" class="selCont">
								<div class="newListSelected" tabindex="0" style="position: relative;outline:none;">
									<div class="selectedTxt" onclick="showTreeOptions()" ></div>
										<ul id="ulTreeOption" style="visibility: visible; width: 140px; top: 19px; left: 0pt; height: auto; display: none;" class="newList">
											<li><a id="aMove" href="JavaScript:void(0);"  onclick="treeOperationsContact(this,'move',<?php echo $treeId; ?>)" onmouseout="operationOut(this)"  onmouseover="operationIn(this);" >
											<?php echo $this->lang->line('txt_Move')?></a></li>
...
"; 
				...
				?>
            <li><a id="liTag0" class="tag"  title="<?php echo $tag_container; ?>" onclick="if(document.getElementById('ulTreeOption')){document.getElementById('ulTreeOption').style.display='none'};showPopWin('<?php  echo base_url();?>add_tag/index/<?php echo  $workSpaceId ; ?>/<?php echo  $workSpaceType ; ?>/<?php echo $treeId ; ?>/1/1', 710, 500, null, '');" href="javascript:void(0);"  ><strong><?php echo $total; ?></strong></a></li>
            <?php	
...
"; 
            ...
            <?php 
					...
					if($total==0)
					{
						$total='';
							...
							$leafdataContent=strip_tags($Contactdetail['firstname'].' '.$Contactdetail['lastname']);
							...
							$leafhtmlContent=htmlentities($Contactdetail['firstname'].' '.$Contactdetail['lastname'], ENT_QUOTES);
        ...
        <!-- user name container -->
        <div id="contact_first_last_name" style="width:100%; height:18px; float:left;"  class="<?php echo $nodeBgColor;?> handCursor <?php echo ($viewTags[0]['systemTag']==1)?$viewTags[0]['tagName']."_systemTag":"";?>">
                      <?php
        ...
        <div id="normalView0_old" class="<?php echo $nodeBgColor;?>  <?php echo ($viewTags[0]['systemTag']==1)?$viewTags[0]['tagName']."_systemTag":"";?>" style="width:100%; float:left; font-weight:normal ">
          <div style="margin-left:15px;width:100%;padding-bottom:5px;">
				...
				<div class="clr"></div>
            	<div class="contactLabel"> <?php echo $this->lang->line('txt_Company_Name');?>:</div>
				...
				{
				?>	
            	<div class="contactLabel"> <?php echo $this->lang->line('txt_Status');?>:</div>
				<div class="contactLabel2"> <?php echo $Contactdetail['comments'];?> </div>
				<div class="clr"></div>		
				<?php						
          		}
				?>
            	<div class="contactLabel"> <?php echo $this->lang->line('txt_Access');?>:</div>
				<div class="contactLabel2"> <?php if($Contactdetail['sharedStatus'] == 2){echo $this->lang->line('txt_Private');}else{echo $this->lang->line('txt_Public');}?> </div>
				<div class="clr"></div>					
		  </div>
         </div>

        <!--Changed by Dashrath- add float:left in div inline css for expand icon ui-->
        <div style="margin-left:15px;width:100%;padding-bottom:5px; float: left;" > 
        	<a href="javascript:showContactDetails();">
	        	<span id="hideShowDetails">
	        		<!--Commented by Dashrath- comment old button code and add new code below with expand icon -->
	        		<!-- <input type="button" name="view_details" value="<?php echo $this->lang->line('txt_View_Details');?>"> -->
	        		<input type="image" src="<?php echo base_url();?>images/expand_icon_new.png" name="view_details">
	        		
	        	</span>
	        </a>

	        <!--Added by Dashrath- this edit icon shift from below-->
	        <span style="padding-left: 15px;">
	        	<input type="image" name="Edit" src="<?php echo base_url();?>images/editnew.png" onClick="contactEdit();">
	        </span> 
	        <!--Dashrath- code end-->
	    </div>
        <!-- close user details --> 
        <!-- -------- user information  -->
        <div id="contactDetails" class="<?php echo $nodeBgColor;?> <?php echo ($viewTags[0]['systemTag']==1)?$viewTags[0]['tagName']."_systemTag":"";?>" style="width:100%; float:left; margin-left:15px;display:none;">
                      <?php 
				if(count($Contactdetail))
				{
				?>
				
					  <div class="contact_details_heading"> <strong><?php echo $this->lang->line('txt_Company_Details');?></strong> </div>
                      ...
                      <div class="contact_details_heading"> <strong><?php echo $this->lang->line('txt_Contact'); /*echo $this->lang->line('txt_Personal_Details');*/?></strong> </div>
                      ...
                      <div class="clr"></div>
                      <?php /*?><div class="contact_details_heading"> <strong><?php echo $this->lang->line('txt_contact_notes');?></strong> </div>
                      <div class="clr"></div><?php */?>
					  <div class="contactLabel" style="font-size:1.2em;"> <strong><?php echo $this->lang->line('txt_contact_notes');?></strong> </div>
          ...
          <div class="contactLabel">
          	...
          	<!--Commented by Dashrath- comment old button code and add new code below with edit icon -->
            <!-- <input type="button" name="Edit" value="<?php echo $this->lang->line('txt_Edit');?>" onClick="contactEdit();"> -->

            <!--Commented by Dashrath- comment edit icon for this code shift above with expand icon-->
            <!-- <input type="image" name="Edit" src="<?php echo base_url();?>images/editnew.png" onClick="contactEdit();"> -->

            <input type="button" name="Cancel" value="<?php echo $this->lang->line('txt_Cancel');?>" onClick="showContactDetails();">
          </div>
                      <?php
				}
				?>
        ...
        <div id="contactDetailsEdit" class="<?php echo $nodeBgColor;?>  <?php echo ($viewTags[0]['systemTag']==1)?$viewTags[0]['tagName']."_systemTag":"";?>" style="width:<?php echo $this->config->item('page_width')-50;?>px; float:left; display:none;">
            ...
            <div class="clr"></div>
            <div class="contactLabel"><?php echo $this->lang->line('txt_user_full_name');?>:</div>
            <!--Dashrath- remove float:left in div inline css and add new class contactInputField-->
            <div style="width:<?php echo $this->config->item('page_width')-200;?>px;" class="contactInputField">
            ...
            <!--Dashrath- remove float:left in div inline css and add new class contactInputField-->
            <div style="width:<?php echo $this->config->item('page_width')-200;?>px;" class="contactInputField">
                          <textarea name="address" rows="3" id="address" style="width:50%;"><?php echo $Contactdetail['address'];?></textarea>
                        </div>
            <div class="clr"></div>
            ...
            <!--Added by Dashrath- Add blank label for ui issue-->
           ...
           <!--Dashrath- remove float:left in div inline css and add new class contactInputField-->
            ...
            <div class="contactLabel">&nbsp;</div>
            <!--Dashrath- remove float:left in div inline css and add new class contactInputField-->
            <div style="width:<?php echo $this->config->item('page_width')-200;?>px; font-weight:normal" class="contactInputField">
        ...
        <!-- -------- move tree code close here  --> 
      	...
      	<!-- contact seed footer start-->
		<div class="commonSeedFooter">

			<!-- footer left content start -->
			<div class="commonSeedFooterLeft">
				<span class="commonSeedLeafSpanLeft" id="normalView0">
					<a href="javascript:reply(0,0);"  style="margin-right:25px;" ><img src="<?php echo base_url(); ?>images/addnew.png" alt="<?php echo $this->lang->line("Add"); ?>" title="<?php echo  $this->lang->line("Add"); ?>"  border="0"></a>
				</span>
			</div>
			...
			<div class="commonSeedFooterRight">
				...
				<span id="ulNodesHeader0" class="ulNodesHeader commonSeedLeafSpanRight">
                    ...
                    <ul  class="content-list" style="float:left; margin: 0 0 0 0;" >
	            		...
	            		<li class="tagLinkTalkSeedLeafIcon">
	            			<a id="liTag0" class="tag"  title="<?php echo $tag_container; ?>" onclick="if(document.getElementById('ulTreeOption')){document.getElementById('ulTreeOption').style.display='none'};showPopWin('<?php  echo base_url();?>add_tag/index/<?php echo  $workSpaceId ; ?>/<?php echo  $workSpaceType ; ?>/<?php echo $treeId ; ?>/1/1', 710, 500, null, '');" href="javascript:void(0);"  ><strong><?php echo $total; ?></strong>
	            			</a>
	            		</li>
						...
						<li  class="talk tagLinkTalkSeedLeafIcon">
							<a id="liTalk<?php echo $leafTreeId?>" href="javaScript:void(0)"  onClick="talkOpen('<?php echo $leafTreeId ?>','<?php echo $workSpaceId ?>','<?php echo $workSpaceType ?>','<?php echo $treeId ?>','<?php echo $talkTitle; ?>','1','','<?php echo $arrVal['nodeId']; ?>')" title="<?php echo $latestTalk ?>" border="0" ><?php echo $total; ?>
							</a>
						</li>
				...
				<span class="commonSeedLeafSpanRight tagStyleNew" style="margin-right: 20px;">
					<?php echo $this->time_manager->getUserTimeFromGMTTime($Contactdetail['createdDate'], $this->config->item('date_format'));?>
				</span>
				<!--create date end-->

				<!--tag name start-->
				<span class="commonSeedLeafSpanRight tagStyleNew">
					<?php echo $originator['userTagName'];?> 
				</span>
				<!--tag name end-->
        ...
        <!-- <div style="height:65px;">
	        <div id="normalView0" class="normalView" style="display:inline"  >
	            <div class="lblNotesDetails"   > 
		            ...
		            <div style="float:left; margin-left:20px;"> <a href="javascript:reply(0,0);"  style="margin-right:25px;" ><img src="<?php echo base_url(); ?>images/addnew.png" alt="<?php echo $this->lang->line("Add"); ?>" title="<?php echo  $this->lang->line("Add"); ?>"  border="0"></a>&nbsp;&nbsp; </div>
		            
		            <div class="style2" style="float:right;width:90%;"> <?php echo $originator['userTagName'];?>&nbsp;&nbsp; <?php echo $this->time_manager->getUserTimeFromGMTTime($Contactdetail['createdDate'], $this->config->item('date_format'));?> </div>
					<div class="clr"></div>
	          	</div>
	        </div>
	        <div class=" lblTagName"     > </div>
        		 ...
        		 <!--Commented by Dashrath- comment add note editor code and shift below for open editor outside of seed-->
		...
		<div class="talkform<?php  echo $treeId;?>">
					  ...
					  <div id="audioRecordBox" style="margin-left:0.2%;"><div style="float:left;margin-top:0.4%; margin-left:1%;"><span id="drop"><a title="Record an audio" style="margin-left:0%; cursor:pointer;" onClick="startAudioRecord(1,'');"><span class="fa fa-microphon"></span></a></span></div><div id="1audio_record" style="display:none; margin-left:1%; margin-top:0%; float:left;"></div></div>
      ...
      <!--Dashrath- comment code end-->
        ...
        <div class="divTagsButton" style="width:auto" >
          ...
          <input type="button" class="button01" value="<?php echo $this->lang->line('txt_Apply_tag');?>" onClick="showNewTag(0,<?php echo $workSpaceId; ?>,<?php echo $workSpaceType; ?>,<?php echo $treeId; ?>,1,0,1,0)" />
				...
				<!--Added by Dashrath- shift this code from above for editor open outside of seed-->
				<!--Changed by Dashrath- add padding-top:15px; in div inline css-->
				<div id="0notes" class="<?php echo $seedBgColor;?>" style="width: 100%;float:left;display:none;padding-top: 15px;">
       				 <?php 
						$firstSuccessor = 0;
					?>
        			<form name="form10" method="post" action="" >
						...
						<div class="talkform<?php  echo $treeId;?> handCursor">
					  	...
					  	<div id="audioRecordBox" style="margin-left:0.2%;">
					  		<div style="float:left;margin-top:0.4%; margin-left:1%;">
					  			<span id="drop">
					  				<a title="Record an audio" style="margin-left:0%; cursor:pointer;" onClick="startAudioRecord(1,'');">
					  					<span class="fa fa-microphon"></span>
					  				</a>
					  			</span>
					  		</div>
					  		<div id="1audio_record" style="display:none; margin-left:1%; margin-top:0%; float:left;">
					  		</div>
					    </div>
                    </form>	 
      			</div>
...
?>
    <div id="contact_list_update">
		...
		if(count($ContactNotes) > 0)
		{
			...
			{	 
				...
				if ($arrVal['nodeId'] == $this->uri->segment(8) || $arrVal['nodeId'] == $this->input->get('node'))
					$nodeBgColor = 'seedBackgroundColorNewForSel';
				else
		...
		?>
                  <div class="clr"></div>
                  <!-- <div onclick="clickNodesOptions('<?php echo $arrVal['nodeId']; ?>')" onmouseout="hideNotesNodeOptions('<?php echo $arrVal['nodeId']; ?>')" onmouseover="showNotesNodeOptions('<?php echo $arrVal['nodeId']; ?>');" class="<?php echo $nodeBgColor; ?> handCursor <?php echo $searchOffset; ?>" id="contactLeafContent<?php echo $arrVal['nodeId']; ?>"> -->

                   <div class="treeLeafRowStyle2"></div>
                   	
                   <div class="<?php echo $nodeBgColor; ?> handCursor <?php echo $searchOffset; ?>" id="contactLeafContent<?php echo $arrVal['nodeId']; ?>" tabindex="0">
...
"; 
        ...
        <div>
            ...
            <div id='leaf_contents<?php echo $arrVal['nodeId'];?>'   style="margin-left: 0%;" class="contentContainerNewUi contentContainer <?php echo ($viewTags[0]['systemTag']==1)?$viewTags[0]['tagName']."_systemTag":"";?>" >
            ...
            <!-- <div style="height:30px;" >
            	<div class="lblNotesDetails normalView"  id="normalView<?php echo $arrVal['nodeId'];?>" style="display:none">
                   	<div class="style2"> <?php echo $userDetails1['userTagName'];?>&nbsp;&nbsp;
					...
					{?>
                        <span style="" class="editLeafMobile"><a href="javascript:editNotesContents1(<?php echo $position;?>,<?php echo $treeId;?>,<?php echo $arrVal['nodeId']; ?>,<?php echo $arrVal['successors']; ?>);"  style="margin-right:25px;" ><img src="<?php echo base_url(); ?>images/editnew.png" alt="<?php echo $this->lang->line("txt_Edit"); ?>" title="<?php echo  $this->lang->line("txt_Edit"); ?>" border="0"></a></span>
                    <?php
					}
					?>    
                </div>
          	 ...
          	 <!-- contact leaf footer start -->
			<div class="commonSeedFooter">
				<!-- footer left content start -->
				<div class="commonSeedFooterLeft">
					<span style="" class="editLeafMobile">
					<?php 
					if($_SESSION['userId'] == $arrVal['userId'])
					{?>
                        <a href="javascript:editNotesContents1(<?php echo $position;?>,<?php echo $treeId;?>,<?php echo $arrVal['nodeId']; ?>,<?php echo $arrVal['successors']; ?>,'<?php echo $arrVal['leafStatus']; ?>');"  style="margin-right:25px;" ><img src="<?php echo base_url(); ?>images/editnew.png" alt="<?php echo $this->lang->line("txt_Edit"); ?>" title="<?php echo  $this->lang->line("txt_Edit"); ?>" border="0"></a>
                    <?php
					}
					else
					{?>
				...
				<div class="commonSeedFooterRight">
					...
					<span class="commonSeedLeafSpanRight">
						<ul id="ulNodesHeader<?php echo $arrVal['nodeId']; ?>" style="float:right; display:inline;margin: 0 0 0 0;" class="content-list ulNodesHeader">
            				<?php
							$viewTags 	= $this->tag_db_manager->getTags(2, $_SESSION['userId'], $arrVal['nodeId'], 2);
							$actTags 	= $this->tag_db_manager->getTags(3, $_SESSION['userId'], $arrVal['nodeId'], 2);
							$contactTags= $this->tag_db_manager->getTags(5, $_SESSION['userId'], $arrVal['nodeId'], 2);
            				...
            				<li class="tagLinkTalkSeedLeafIcon">
            					<a id="liTag<?php echo $arrVal['nodeId']; ?>" class="tag" onclick="showPopWin('<?php  echo base_url();?>add_tag/index/<?php echo  $workSpaceId ; ?>/<?php echo  $workSpaceType ; ?>/<?php echo $arrVal['nodeId'] ; ?>/2/1', 710, 500, null, '');" href="javascript:void(0);" title="<?php echo strip_tags($tag_container,''); ?>"  ><strong><?php echo $total; ?></strong>
            					</a>
            				</li>

            				<?php				
							/*Changed by Dashrath- add $docTrees10 for total*/
							$total=sizeof($docTrees1)+sizeof($docTrees2)+sizeof($docTrees3)+sizeof($docTrees4)+sizeof($docTrees5)+sizeof($docTrees6)+sizeof($docTrees7)+sizeof($docTrees10);
							//echo "<li>total= " .$total;
							$appliedLinks=' ';
					...
					?>
						...
						<a href="javascript:void(0)" onClick="deleteLeaf('<?php echo $arrVal['leafId']; ?>','<?php echo $workSpaceId; ?>','<?php echo $workSpaceType; ?>','<?php echo $treeId; ?>', 'contact')" title="<?php echo $this->lang->line('txt_delete'); ?>" border="0" ><img src="<?php echo  base_url(); ?>images/trash.gif" alt="<?php echo $this->lang->line("txt_del"); ?>" title="<?php echo $this->lang->line("txt_delete"); ?>" border="0">
						</a>
        ...
        <?php /*?><div id="<?php echo $position;?>edit_contacts" style="width:92%; float:left; display:none;"> </div><?php */?>
        <div class="clr"></div>
      </div>
...
<script language="javascript">
	$(window).scroll(function(){
      ...
      /*Commented by Dashrath- comment old code and new code with if else condition*/
      //call addAndRemoveClassOnSeed function
	  //addAndRemoveClassOnSeed($(this).scrollTop());

	  /*Added by Dashrath- Add condition for when open contact details and edit contact details in seed remove class documentTreeFixed*/
	  if($('#contactDetails').css('display') == 'none' && $('#contactDetailsEdit').css('display') == 'none')
  	  {
  	  	addAndRemoveClassOnSeed($(this).scrollTop()); 
  	  }
  	  else
	...
	function editNotesContents1(position,treeId,nodeId,successors, leafStatus)
	{
	   
	    /*Added by Dashrath- add for set parameter default value*/
		if(leafStatus === undefined) {
		    leafStatus = '';
		}
		/*Dashrath- code end*/
	   ...
	   if(document.getElementById('editStatus').value == 1)
		...
		else
		{
			...
			/*Commented by Dashrath- this code replace by if else condition below */
			//contents=document.getElementById("leaf_contents"+nodeId).innerHTML; 

			/*Added by Dashrath- check deleted status for remove contents from editor */
			...
			document.getElementById('editorLeafContents'+id1+'1sp').innerHTML='<table border="0" align="left" cellpadding="2" cellspacing="0"><tr><td colspan="2" align="center"><a href="javascript:void(0)" onclick="validate_dis1(\'editorLeafContents'+id1+'1\',document.form2)"><input type="button"  class="button01" value="<?php  echo  $this->lang->line("txt_Done"); ?>"   /></a></td> <td colspan="2" align="center"><div id="loaderImage"></div><a href="javascript:void(0)" onclick="edit_close_1('+id1+','+nodeId+')"><input type="button"  class="button01" value="<?php  echo  $this->lang->line("txt_Cancel"); ?>"   /></a></td></tr></table><div id="audioRecordBox"><div style="float:left;margin-top:0.5%;margin-left:1%;"><span id="drop"><a title="Record an audio" style="margin-left:0%; cursor:pointer;" onClick="startAudioRecord(3,'+id1+');"><span class="fa fa-microphon"></span></a></span></div><div id="3audio_record'+id1+'" style="display:none; margin-left:1%; margin-top:0.1%; float:left;"></div></div>';
...
{	
    ...
    //function to get value from editor or textarea
