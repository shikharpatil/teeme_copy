...
<!-- <div  onclick="clickNodesOptions('<?php echo $arrVal['nodeId']; ?>')" onMouseOut="hideNotesNodeOptions('<?php echo $arrVal['nodeId']; ?>')"  onmouseover="showNotesNodeOptions('<?php echo $arrVal['nodeId']; ?>');" class="<?php echo $nodeBgColor; ?> handCursor" id="contactLeafContent<?php echo $arrVal['nodeId']; ?>" > -->
	...
	<div class="<?php echo $nodeBgColor; ?> handCursor" id="contactLeafContent<?php echo $arrVal['nodeId']; ?>" >
...
<!--     <div style="height:30px;" >
      <div class=" lblNotesDetails normalView"  id="normalView<?php echo $arrVal['nodeId'];?>"  style="display:inline"    >
        <div class="style2" style="width:85%;"  > <?php echo $userDetails1['userTagName'];?>&nbsp;&nbsp;
				...
				<div class="commonSeedFooterRight">
					...
					<span class="commonSeedLeafSpanRight">
          				<ul id="ulNodesHeader<?php echo $arrVal['nodeId']; ?>" style="float:right; display:inline;margin: 0 0 0 0;" class="content-list ulNodesHeader">
							...
							<li  class="talk tagLinkTalkSeedLeafIcon"><a id="liTalk<?php echo $leafTreeId; ?>" href="javaScript:void(0)" onClick="talkOpen('<?php echo $leafTreeId; ?>','<?php echo $workSpaceId ?>','<?php echo $workSpaceType ?>','<?php echo $treeId ?>','<?php echo $talkTitle; ?>','0','','<?php echo $arrVal['nodeId']; ?>')" title="<?php echo $latestTalk ?>" border="0" ><?php echo $total; ?></a></li>
							<input type="hidden" value="<?php echo $leafhtmlContent; ?>" name="talk_content" id="talk_content<?php echo $leafTreeId; ?>"/>
							<?php
							//echo '<li  class="talk"><a id="liTalk'.$leafTreeId.'" href="javaScript:void(0)"  onClick="window.open(\''.base_url() .'view_talk_tree/node/' .$leafTreeId .'/'. $workSpaceId.'/type/'.$workSpaceType.'/ptid/'.$treeId.'\' ,\'\',\'width=850,height=500,scrollbars=yes\') " title="'.$latestTalk.'" border="0" >'.$total.'</a></li>';
  ...
  <?php /*?><div id="<?php echo $position;?>edit_contacts" style="width:92%; <?php //echo $this->config->item('page_width')-50; px ?> float:left; display:none;"> </div><?php */?>
  <div class="clr"></div>
</div>
