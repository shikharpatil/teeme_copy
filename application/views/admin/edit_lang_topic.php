				...
				<!-- Main Body -->
                    ...
                    <tr>
                      <td class="subHeading" colspan="4">
						<form name="frmTopic" action="<?php echo base_url().'admin/admin_help/edit_lang_topic/'.$topicId;?>/<?php echo strtolower($langCode);?>" method="post">
                        ...
                        <tbody>
                          <tr>
                            <td width="179" align="left" valign="middle"><?php echo $this->lang->line('txt_Language');?>: </td>
                            <td align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                            <td align="left" valign="top" class="text_gre1">
														<?php
							echo $languages[$langCode];
								
                           ?></td>
                          </tr>
						   <tr>
                            <td width="179" align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_Topic_Name');?>: </td>
                            <td width="5" align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                            <td width="512" align="left" valign="top" class="text_gre1">
                               	<?php
							echo $arrTopics['topicName'];
								
                           ?>                 
                            </td>
                          </tr>
                          <tr>
                            <td width="179" align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_Translated_Name');?>:<span class="text_red">*</span></td>
                            <td width="5" align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                            <td width="512" align="left" valign="top" class="text_gre1">
                              <input name="topic" class="text_gre1" id="topic" size="30" value="<?php echo $arrLangTopics['topicText'];?>"/>                             
                            </td>
                          </tr>
                          <tr>
