				...
				<!-- Main Body -->
				    ...
				    <tr>
				      <td colspan="4" class="tdSpace">
					    ...
					    <li><a href="<?php echo base_url().'admin/admin_help/create_sub_topic';?>" class="current"><span><?php echo $this->lang->line('txt_Create_Sub_Topic');?></span></a></li>
					    </ul>				
				      </td>
				    </tr>
				    <tr>
                    ...
                    <tr>
                      <td class="subHeading" colspan="4">
						<form name="frmTopic" action="<?php echo base_url().'admin/admin_help/create_sub_topic';?>" method="post">
                        ...
                        <tbody>
                          <tr>
                            <td width="179" align="left" valign="middle"><?php echo $this->lang->line('txt_Select_Topic');?>:<span class="text_red">*</span></td>
                          ...
                          <tr>
                            ...
                            <td width="512" align="left" valign="top" class="text_gre1">
                              <input name="subTopic" class="text_gre1" id="topic" size="30" />                             
                            </td>
                          </tr>
                          <tr>
                            ...
                            <td width="5" align="center" valign="top" class="text_gre"><strong>:</strong></td>
                            <td width="512" align="left" valign="top" class="text_gre1">
                             <textarea rows="7" cols="60" name="contents"></textarea>                           
                            </td>
                          </tr>
                          <tr>
