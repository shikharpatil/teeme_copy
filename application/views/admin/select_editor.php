          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="<?php echo $this->config->item('page_width')-55;?>" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<!-- Start Main Body -->
                    ...
                    <tr>
                    	<td align="center" valign="top" height="50"><h1>Select Editor</h1></td>
                    </tr>
                    <tr>
                    	<td><h2>Advance Editor:</h2></td>
                    </tr>
                    <?php 	if(count($editorDetails) > 0)
							{
					?>
                    <form name="frmSelectEditor" action="<?php echo base_url();?>admin/admin_home/select_editor" method="post">
					...
					?>
                    <tr>
                    	<td><input type="radio" name="editor_adv" value="<?php echo $editorData['editorId']; ?>" <?php if($editorData['editorStatus']) echo "checked"; ?> /><?php echo $editorData['editorName']; ?></td>
                    </tr>
                    <?php
								}
							}
					...
					?>
                    <tr>
                    	<td><input type="radio" name="editor_simple" value="<?php echo $editorData['editorId']; ?>" <?php if($editorData['editorStatus']) echo "checked"; ?> /><?php echo $editorData['editorName']; ?></td>
                    </tr>
                    <?php
								}
							}
                    ...
                    <tr>
                    	<td height="50" valign="bottom" align="center"><input type="submit" name="Submit" value="Activate" /></td>
                    </tr>
                     </form>
                    <?php		
							}
