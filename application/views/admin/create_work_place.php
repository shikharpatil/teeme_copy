          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF">
				...
				<!-- end Right Part -->
                  ...
                  <td align="left" valign="top">
				<!-- Main Body -->
			  <form name="frmWorkPlace" id="frmWorkPlace" action="<?php echo base_url();?>admin/admin_home/add_work_place" method="post" onSubmit="return validateWorkPlace(this)">
...
<select name="place_timezone">
	...
	<option value='75'>(GMT+13:00) Nuku'alofa</option>
                        ...
                        <tr>
                          ...
                          <td align="left" class="text_gre"><input name="companyAddress1" class="text_gre1" id="companyAddress1" size="30" value="" /></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_Address');?>2</td>
                          <td align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                          <td align="left" class="text_gre"><input name="companyAddress2" class="text_gre1" id="companyAddress2" size="30" value="" /></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_City');?></td>
                          <td align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                          <td align="left" class="text_gre"><input name="companyCity" class="text_gre1" id="companyCity" size="30" value="" /></td>
                        </tr>
                        <tr>
                          <td align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_State');?></td>
                          <td align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                          <td align="left" class="text_gre"><input name="companyState" class="text_gre1" id="companyState" size="30" value="" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                          <td align="left" class="text_gre"><input name="companyZip" class="text_gre1" id="companyZip" size="30" value="" /></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                          <td align="left" class="text_gre"><input name="companyFax" class="text_gre1" id="companyFax" size="30" value="" /></td>
                        </tr>
                      </tbody>
                  </table></td>
                </tr>
                ...
                <tr>
                	<td width="135" align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_User_Community_Name');?></td>
                    <td width="5" align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                    <td colspan="2" align="left" valign="top" class="text_gre1">
                    		<select name="communityId" onChange="openRegisterForm(this)" id="communityId">
                      		<?php
                ...
                (xxx-xxx-xxxx) </td>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="middle"><span class="text_gre"><strong>:</strong></span></td>
                          <td align="left">
                            <input name="fax" class="text_gre1" id="fax" size="30" value=""/></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_User_Name');?> <span class="text_red">*</span> </td>
                          <td align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                          <td align="left" class="text_gre"><input name="userName" class="text_gre1" id="userName" size="30" onKeyUp="checkUserName(this)"/>
&nbsp;<span id="userNameStatusText"></span></td>
                        ...
                        <tr>
                          ...
                          <td align="center" valign="middle"><span class="text_gre"><strong>:</strong></span></td>
                          <td align="left"><input name="email" class="text_gre1" id="email" size="30" value=""/></td>
                        </tr>                        
                        <tr>
                    ...
                    <table width="80%" border="0" cellpadding="3" cellspacing="0" bordercolor="#111111" class="text_gre1" id="table12" style="border-collapse: collapse;">
                      <tbody>
                        <tr>
                          <td width="135" align="left" valign="middle" class="text_gre1"><span id="otherCommunityName">yahoo</span><?php echo ' ' .$this->lang->line('txt_Email');?><span class="text_red">*</span></td>
                          <td width="5" align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                          <td align="left" class="text_gre">
                            <input type="text" name="otherUserName" class="text_gre1" id="otherUserName" size="30" value="" onKeyUp="checkUserName(this)"/>
                ...
                <tr>
                  <td colspan="2">&nbsp;</td>
                  <td colspan="2"><input type="submit" name="Submit" value="<?php echo $this->lang->line('txt_Register');?>"></td>
                </tr>
              </table>
