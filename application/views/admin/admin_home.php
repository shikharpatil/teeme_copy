<?php /*Copyright © 2008-2014. Team Beyond Borders Pty Ltd. All rights reserved.*/ ?><html>
	<head>
          ...
          <tr>
            <td style="background-image:url(<?php echo base_url();?>images/blue-bg.gif); background-repeat:repeat-x" class="padding"><table width="100%" border="0" cellspacing="1" cellpadding="1">
                <tr>
                  ...
                  <td width="97%" align="left" class="one"><h1><a href="javascript:void(0)" onClick="extendMenus('companyExtendLinks')">Manage Work Place </a></h1></td>
                </tr>				 
            </table>
			...
			<table width="93%" border="0" cellspacing="1" cellpadding="1" align="right">
				<tr>
					<td width="1%" align="left">&nbsp;</td>
					<td width="2%" align="left"><img src="<?php echo base_url();?>images/item.gif" width="15" height="16" /></td>
					<td width="97%" align="left" class="one"><h1><a href="<?php echo base_url();?>admin/admin_home/view_work_places">View Work Places </a></h1></td>
				</tr>	
				<tr>
					<td width="1%" align="left">&nbsp;</td>
					<td width="2%" align="left"><img src="<?php echo base_url();?>images/item.gif" width="15" height="16" /></td>
					<td width="97%" align="left" class="one"><h1><a href="<?php echo base_url();?>admin/admin_home/create_work_place">Create Work Place </a></h1></td>
				</tr>	
