          ...
          <tr>
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="<?php echo $this->config->item('page_width')-55;?>" border="0" align="center" cellpadding="0" cellspacing="0">
				...
				<!-- end Right Part -->
                  ...
                  <td align="left" valign="top">
				<!-- Main Body -->
			  <form name="frmAdminEdit" id="frmAdminEdit" action="<?php echo base_url();?>admin/admin_home/update_admin/<?php echo $adminDetails['adminId'];?>" method="post" onSubmit="return validateAdminEdit()">
            ...
            &nbsp;<span id="workPlaceStatusText"></span> </td>
                ...
                <tr>
                  ...
                  <input type="submit" name="Submit" value="<?php echo $this->lang->line('txt_Done');?>"></td>
                </tr>
              </table>            
            </form>
				<!-- Main Body -->
