          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF"> 
				...
				<?php if(($user_trial_place_status==1 || $trial_place_url_status==1) && $this->uri->segment(3)!='1')
				{
				 ...
				 { ?>
              		...
              		<table width="100%" border="0" cellspacing="0" cellpadding="3" class="text_gre1" id="table12" style="border-collapse: collapse;">
           ...
           <ul class="tab_menu_new1">
			...
			<div class="clr"></div>
             ...
             <div><span id="workPlaceStatusText" style="font-size:11px"><?php echo $this->lang->line('lower_case_numbers_only_txt'); ?></span></div> </td>

                        </tr>

                       

                            <input type="hidden" name="server" class="text_gre1" id="server" size="20" value="<?php echo base64_decode ($this->config->item('hostname')); ?>"/>

                       
                            <input type="hidden" name="server_username" class="text_gre1" id="server_username" size="20" value="<?php echo base64_decode ($this->config->item('username')); ?>"/>

                            <input type="hidden" name="server_password" class="text_gre1" type="password" id="server_password" size="20" value="<?php echo base64_decode ($this->config->item('password')); ?>"/>

							<input type="hidden" name="instance_name" id="instance_name" size="20" value="<?php echo $this->config->item('instanceName');?>" type="hidden"/>

                            <input type="hidden" name="instance_name1" class="text_gre1" id="instance_name1" size="20" value="<?php echo $this->config->item('instanceName');?>" disabled="disabled"/>
                        ...
                        <tr>
                          ...
                          <td align="left" class="text_gre">
								...
								<select name="place_timezone" id="place_timezone" style="width:100%;"> 
                        ...
                        <tr>
						 ...
						 <tr>
                          ...
                          <td align="left" class="text_gre">
                          	...
                          	<!--<input name="companyAddress1" class="text_gre1" id="companyAddress1" size="20" value="" />-->
						...
						<?php /*?><tr>
                          	...
                          	<td align="left" class="text_gre">
							<input type="file" name="restorePlace" class="text_gre1" id="restorePlace" size="20" value="" /> 
							&nbsp;
					   ...
					   <tr>
						  ...
						  <td class="heading" colspan="4" style="padding-top:8%;"><?php echo $this->lang->line('txt_Workplace_Manager_Details');?></td>
		
						</tr>

						<tr>
						<td colspan="3" class="tdSpace" style="height:6px;">
						</td>
						</tr>
                        <tr>
						...
						<tr>
						  ...
						  <?php
							/*
                          pm_ <input name="tagName" type="text" autocapitalize="off" class="text_gre1" id="tagName" size="20" onfocus="checkTagName(this,<?php echo $workPlaceId;?>,1)" onkeyup="checkTagName(this,<?php echo $workPlaceId;?>,1)" value="<?php echo $this->input->post('tagName');?>"/>&nbsp;<span id="tagNameStatusText"></span><br /><span style="color:#006600" id="tagNameSuggestions"></span>
							*/
							?>
						...
						<!--User time zone view start here-->
                          ...
                          <td align="left" class="text_gre">
							...
							<select name="user_timezone" id="user_timezone" style="width:100%;">
						...
						*/
                        ...
                        <tr>
                          ...
                          <td align="left" class="text_gre"><input type="hidden" name="email" class="text_gre1" id="email" size="20" value="<?php echo $email; ?>"/>
						  	   <input name="email1" class="text_gre1" id="email1" size="20" value="<?php echo $email; ?>" disabled="disabled"/>
