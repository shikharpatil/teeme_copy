    ...
    <div class="main_menu btm-border" >
      <ul class="tab_menu_new_up_for_mobile">
        ...
        <?php 
							...
							{
						?>
        <li style="width:110px!important;"><a href="<?php echo base_url()?>workspace_home2/sharedTrees/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" class="active"><span><?php echo $this->lang->line('txt_Shared_Trees');?></span></a></li>
        <?php
							}
						?>
      </ul>
    ...
    <table width="150%" border="0"  cellpadding="3" cellspacing="3" class="dashboard_bg">
      <tr>
        <td align="left" valign="top"><?php       
						...
						{     
							$arrTreeDetails = $this->identity_db_manager->getSharedTreeDetailsBySearchOptions($workSpaceId, $workSpaceType, $treeTypes, $created, $modified, $list, $by);	
...
function showFilteredMembers()
{
	...
	var val = '';
		...
		if (1)
		{
          ...
          <form name="frmCal" action="<?php echo base_url()?>workspace_home2/sharedTrees/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" method="post" onSubmit="return validateCal()">
