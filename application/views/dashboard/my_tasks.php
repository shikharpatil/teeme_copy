    ...
    <div class="main_menu btm-border"  >
      <div style="display:none;" id="menu2_for_web">
        <ul class="tab_menu_new_up">
          ...
          <li><a href="<?php echo base_url()?>workspace_home2/my_tasks/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1" class="active"><span><?php echo $this->lang->line('txt_My_Tasks');?></span></a></li>
