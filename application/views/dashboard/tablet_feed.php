	...
	<div id="container">
		...
		<div id="rightSideBar">
			...
			<div>
				...
				<div>
	                <ul class="tab_menu_new">
	                	<li>
	                    	...
	                    	<a style="padding:10px 18px; margin-bottom:0px;" href="javascript:void(0);" id="tabm1" class="active" onclick="$('#dashboardFeedLeftContent').show();$('#dashboardFeedRightContent').hide();$('#tabm2').removeClass('active');$('#tabm1').addClass('active');"><img src="<?php echo base_url();?>images/home_gray_btn.png" /></a>

	                    </li>
	                	<li>

	                		<a style="padding:10px 18px;margin-bottom:0px;" href="javascript:void(0);" id="tabm2" onclick="$('#dashboardFeedLeftContent').hide();$('#dashboardFeedRightContent').show();$('#tabm1').removeClass('active');$('#tabm2').addClass('active');"><img src="<?php  echo base_url().'images/history-icon.png'; ?>" /></a>
				...
				<div id="dashboardFeedLeftContent" style="width: 100%;">
					<!--feed id div start-->
					<div id="feed">
						<?php 
				...
				<div id="dashboardFeedRightContent" style="display: none; width: 100%;">
					<?php 
