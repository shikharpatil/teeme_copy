...
<div id="container">
    ...
    <div class="main_menu btm-border" >
        ...
        <ul class="tab_menu_new_up">
              ...
              <li><a  href="<?php echo base_url()?>workspace_home2/updated_talk_trees/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1" class="active" ><span><?php echo $this->lang->line('txt_Updated_Talks');?></span></a></li>
    ...
    <div style="margin-top:10px;" >
        ...
        <div  class="row-active-header">
              <div class="row-active-header-inner1" > <span class="rowHeaderFont" ><?php echo $this->lang->line('txt_Updated_Talks');?></span> </div>
...
echo '<a href='.base_url().'view_document/index/'.$workSpaceId.'/type/'.$workSpaceType.'/?treeId='.$data["parentTreeId"].'&doc=exit&node='.$data['leaf_id'].'&tagId=1 target="_blank" class="example7">' .$this->identity_db_manager->formatContent($data['name'],50,1). '</a>';													
 ...
 ?>
            ...
            <?php
              ...
              <div class="row-active-header-inner3"  > <span><?php echo $this->lang->line('txt_Modified_Date');?>: </b><?php echo $this->time_manager->getUserTimeFromGMTTime(strip_tags($data['editedDate']),'m-d-Y h:i A'); ?></span> </div>
              <div class="clr"></div>
            </div>
        <?php
						}
        ...
        <div class="<?php echo $nodeBgColor; ?> ">
            ...
            <?php
              ...
              <div class="row-active-header-inner3"  > <span>
                <?php  echo $this->time_manager->getUserTimeFromGMTTime(strip_tags($data['editedDate']),'m-d-Y h:i A'); ?>
                </span> </div>
              <div class="clr"></div>
            </div>
        <?php	
