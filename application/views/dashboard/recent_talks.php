...
<div id="container">
    ...
    <div class="main_menu btm-border" >
        ...
        <li><a href="<?php echo base_url()?>workspace_home2/talks/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" class="active"><span><?php echo $this->lang->line('txt_Talks');?></span></a></li>
