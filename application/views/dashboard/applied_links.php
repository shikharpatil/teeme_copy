  ...
  <div id="content">
    ...
    <div class="main_menu btm-border" >
      <ul class="tab_menu_new_up">
        ...
        <li><a href="<?php echo base_url()?>workspace_home2/links/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" class="active"><span><?php echo $this->lang->line('txt_Applied_Links');?></span></a></li>
