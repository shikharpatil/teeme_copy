  ...
  <div id="content">
    ...
    <div class="main_menu btm-border" >
      <ul class="tab_menu_new_up_for_mobile">
        ...
        <li style="width:106px!important;"><a href="<?php echo base_url()?>workspace_home2/tags/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" class="active"><span><?php echo $this->lang->line('txt_Applied_Tags');?></span></a></li>
