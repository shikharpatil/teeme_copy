					   ...
					   <?php
					    ...
					    <tr>
                         ...
                         <td align="left" class="text_gre">
                         	...
                         	<input type="radio" name="treeAccess" value="0"  <?php  if($workSpaceDetails['treeAccess']==0 ) echo 'checked="checked"'; ?>   /><?php echo $this->lang->line('txt_Space_Managers');?><br />
