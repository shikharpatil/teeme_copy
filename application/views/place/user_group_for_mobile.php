...
<?php $this->load->view('common/wp_header'); ?>
		...
		<div id="content">
				...
				<form name="frmWorkPlace" action="<?php echo base_url();?>user_group/add" method="post" onSubmit="return validateGroup(this)" style="margin-top:5%;">
				...
				?>						                  
                       ...
                       <tr>
                         ...
                         <td width="485" align="left" class="text_gre">
                           ...
                           <input name="userGroupName" class="text_gre1" id="userGroupName" value=""/>&nbsp;<span id="workPlaceStatusText"></span>
