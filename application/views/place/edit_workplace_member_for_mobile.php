...
<?php $this->load->view('common/wp_header'); ?>
        ...
        <table width="<?php echo $this->config->item('page_width')-25;?>" border="0" align="center" cellpadding="0" cellspacing="0">
			...
			<!-- Main menu -->	
			  	...
			  	<div id="container_for_mobile" style="padding:0px 0px 10px">
				...
				<div id="content">
				    ...
				    <table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-left:9%;">
			...
			<form action="<?php echo base_url();?>edit_workplace_member/update" method="post" enctype="multipart/form-data" name="frmWorkPlace" id="frmWorkPlace" onSubmit="return validateWorkPlaceMemberEditPlace(this)">
				...
				?>
                       ...
                       <?php /*?> <tr>
                  			...
                  			<td valign="top"><?php echo $this->lang->line('txt_Authenticate_with');?></td>
                        ...
                        <tr>
                          ...
                          <td align="left" class="text_gre"><input name="userName" class="text_gre1" id="userName" size="20" onKeyUp="checkUserName(this,<?php echo $_SESSION['workPlaceId'];?>)" readonly="readonly" value="<?php echo $Profiledetail['userName'];?>"/>
...
&nbsp;<span id="userNameStatusText"></span></td>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_First_Name');?><span class="text_red">*</span></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" valign="top" class="text_gre1">

                            <input name="firstName" class="text_gre1" id="firstName" size="20" value="<?php echo $Profiledetail['firstName'];?>" readonly="readonly"/>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Last_Name');?><span class="text_red">*</span></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" class="text_gre">

                            <input name="lastName" class="text_gre1" id="lastName" size="20"  value="<?php echo $Profiledetail['lastName'];?>" readonly="readonly"/>
						...
						<tr>
						  ...
						  <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_nick_name');?></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" class="text_gre">

                            <input name="nickName" class="text_gre1" id="nickName" size="20"  value="<?php echo $Profiledetail['editNickName'];?>" />
						...
						<tr>
                          ...
                          <td align="left" class="text_gre"><input name="tagName" type="text" class="text_gre1" id="tagName" size="20" value="<?php echo $Profiledetail['editUserTagName'];?>" readonly /></td>
                        ...
                        <!--User time zone view start here-->
                          ...
                          <td align="left" class="text_gre">
							...
							<select name="timezone" id="timezone" style="width:76%;">
						...
						<!--User time zone view end here-->
                         ...
                         <tr>
                          ...
                          <td width="512" align="left" valign="top" class="text_gre1">
                            ...
                            <input type="file" name="photo" class="text_gre1" id="photo" size="20" value="" /> (jpg, jpeg, png, gif only)
                        ...
                        <tr style="display:none;">
                          ...
                          <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Photo');?></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" valign="top" class="text_gre1">

                            <input type="file" name="photo" class="text_gre1" id="photo" size="20" value="" /><br /> (jpg, jpeg, png, gif only)
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Role');?></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" class="text_gre">

                            <input name="role" class="text_gre1" id="role" size="20"  value="<?php echo stripslashes($Profiledetail['role']);?>"/>
                          ...
                          <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Department');?></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" class="text_gre">

                            <input name="department" class="text_gre1" id="department" size="20"  value="<?php echo stripslashes($Profiledetail['department']);?>"/>
                        ...
                        <tr style="display:none;">
                          ...
                          <td align="left" class="text_gre1">
                            ...
                            <input name="phone" class="text_gre1" id="phone" size="20" value="<?php echo $Profiledetail['phone'];?>"/></td>
                        ...
                        <tr>
                          ...
                          <td align="left">
                            ...
                            <input name="mobile" class="text_gre1" id="mobile" size="20" value="<?php echo $Profiledetail['mobile'];?>"/></td>

                        </tr>                     

                        <tr style="display:none;">

                          <td align="left" valign="top" class="text_gre1"><?php echo stripslashes($this->lang->line('txt_Other_Details'));?></td>
                        ...
                        <tr>
						 ...
						 <tr>
                          ...
                          <td align="left" class="text_gre">
                              ...
                              <input type="radio" name="isPlaceManager" id="isPlaceManager1" value="1" <?php if( $Profiledetail['isPlaceManager'] == 1 ) { echo 'checked'; }?> <?php if( $Profiledetail['userGroup'] == 0 ){ echo 'disabled'; }?>>Yes</input>
                              <input type="radio" name="isPlaceManager" id="isPlaceManager0" value="0" <?php if( $Profiledetail['isPlaceManager'] != 1 ) { echo 'checked'; }?> <?php if( $Profiledetail['userGroup'] == 0 ){ echo 'disabled'; }?>>No</input>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="left" class="text_gre">
                          	...
                          	<input type="hidden" name="email" class="hidden" id="email" size="20" value=""/>

                            <input type="hidden" name="userId" class="hidden" id="userId" size="20" value="<?php echo $Profiledetail['userId'];?>"/>

                            <input type="hidden" name="workSpaceId" class="hidden" id="workSpaceId" size="20" value="<?php echo $workSpaceId;?>"/>

                            <input type="hidden" name="workSpaceType" class="hidden" id="workSpaceType" size="20" value="<?php echo $workSpaceType;?>"/>

                            <input type="hidden" name="userPassword" class="hidden" id="userPassword" size="20" value="<?php echo $Profiledetail['password'];?>"/>
