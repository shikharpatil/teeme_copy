...
<script language="javascript">
	...
	<script language="JavaScript" src="<?php echo base_url();?>js/mm_menu.js"></script>
	 ...
	 <?php
		...
		$usersIds = array();
		foreach($groupUsers as $usersData)
		{
			$usersIds[] = $usersData['userId'];
		}
		/*print_r($usersIds);
		exit;*/
	...
	var val = '';
...

		{
			...
			foreach($workPlaceMembers as $keyVal=>$workPlaceMemberData)	
			{
				...
				if ((in_array($workPlaceMemberData['userId'],$usersIds)) && ($workPlaceMemberData['userGroup']>0))
				{
			...
			var str = '<?php echo $workPlaceMemberData['tagName']; ?>';
				...
				if (toMatch!='')
				{
					...
					{
						val +=  '<input class="mngrs" type="checkbox" name="workSpaceManagers[]" value="<?php echo $workPlaceMemberData['userId'];?>" <?php if(in_array($workPlaceMemberData['userId'],$usersIds)) { echo 'checked'; } ?>/><?php echo $workPlaceMemberData['tagName'];?><br>';
...
<div id="container_for_mobile" style="padding:0px 0px 40px">
		<div id="content">
			...
			<!-- Main menu -->	
					...
					$groupUsersList = implode(",",$usersIds); 
					
					?>		

					<!-- Main Body -->
				<form name="frmWorkPlace" action="<?php echo base_url();?>user_group/updateGroup" method="post"  onSubmit="return validateGroup(this)">

				<input value="<?php echo $groupUsersList ?>" id="groupUsersList" type="hidden" name="groupUsersList" />
				...
				<div class="menu_new" >
						...
						<li style="margin:0px!important;width:100px!important;"><a href="<?php echo base_url()?>user_group" class="active"><span><?php echo $this->lang->line('txt_user_group');?></span></a></li>
				...
				?>	
				  ...
				  <tr>
                    ...
                    <td class="subHeading" colspan="3"><?php echo $this->lang->line('txt_Edit_User_Group');?></td>
                     ...
                     <tbody>                    
                       ...
                       <tr>
                         ...
                         <td width="485" align="left" class="text_gre">
                           ...
                           <input name="userGroupName" class="text_gre1" id="userGroupName" value="<?php echo $groupDetails['groupName'];?>" //>&nbsp;<span id="workPlaceStatusText"></span>
                       ...
                       <tr>
                         ...
                         <td align="left" class="text_gre">
							...
							?>
										...
										<input type="checkbox" class="mngrs" name="workSpaceManagers[]" value="<?php echo $workPlaceMemberData['userId'];?>" <?php if(in_array($workPlaceMemberData['userId'],$usersIds)) { echo 'checked'; } ?>/> 
		...
		<div style="margin-top:3%">
			<?php $this->load->view('place/show_user_groups_for_mobile');?>
		</div>	
...
{	
	...
	if (err == '')
	{
		var msg= "<?php echo $this->lang->line('msg_group_update'); ?>";
