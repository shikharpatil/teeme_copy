			...
			foreach($arrNewNodeIds as $key => $value)
			{
				...
				{	
					...
					$i = 1;	
						...
						{				
							$docArtifactLinks[] = '<a href="'.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/4/'.$data['treeId'].'">'.strip_tags($treeName).'</a>'; 	
						}
				...
				{	
					...
					$i = 1;	
						...
						{					
							$disArtifactLinks[] = '<a href="'.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/4/'.$data['treeId'].'">'.strip_tags($treeName).'</a>';  	
						}
				...
				{	
					...
					$i = 1;	
						...
						{				
							$chatArtifactLinks[] = '<a href="'.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/4/'.$data['treeId'].'">'.strip_tags($treeName).'</a>'; 	
						}
				...
				{	
					...
					$i = 1;	
						...
						{
							$activityArtifactLinks[] = '<a href="'.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/4/'.$data['treeId'].'">'.strip_tags($treeName).'</a>';  	
						}
				...
				{	
					...
					$i = 1;	
						...
						{					
							$contactArtifactLinks[] = '<a href="'.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/4/'.$data['treeId'].'">'.strip_tags($treeName).'</a>';  	
						}
				...
				{	
					...
					$i = 1;	
						...
						{
							$notesArtifactLinks[] = '<a href="'.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/4/'.$data['treeId'].'">'.strip_tags($treeName).'</a>';  	
						}
				...
				{	
					...
					if(count($docTrees) > 0)
					{
						...
						{
							$importArtifactLinks[] = '<a href="'.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/4/'.$data['docId'].'">'.$docName.'_v'.$data['version'].'</a>'; 
						}
				...
				{	
					...
					$i = 1;	
						...
						{
							$urlStore[] = '<a href="'.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/4/'.$data['urlId'].'">'.strip_tags($urlName).'</a>';  	
						}
...
?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" >
        ...
        <td id="<?php echo $position++;?>" class="handCursor treeLeafView"><?php
					...
					echo '<a href='.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/1/'.$treeId.' style="text-decoration:none; color:#000;">'.stripslashes(substr($arrDiscussionDetails['name'],0,250)).'</a>';
...
?>
    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:5px; border-spacing:3px;" >
          <?php
	$totalNodes = array();
	$nodeBgColor = '';
        ...
        <td colspan="5" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr class="<?php echo $nodeBgColor;?>">
              <td colspan="3" id="<?php echo $position++;?>" class="handCursor treeLeafView"><?php
					...
					echo '<div><a href='.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/1/'.$arrVal["nodeId"].'#discussLeafContent'.$arrVal["nodeId"].' style="text-decoration:none; color:#000; font-size:0.9em;">'.stripslashes(substr($arrVal['contents'],0,250)).'</a></div>';
		...
		if($arrparent['successors'])
		{
			...
			?>
                    <tr class="<?php echo $nodeBgColor; ?>">
					  ...
					  /*$this->identity_db_manager->formatContent($arrDiscussions['contents'],250)*/
					echo '<div><a href='.base_url().'view_chat/chat_view/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/1/'.$arrDiscussions["nodeId"].'#discussLeafContent'.$arrDiscussions["nodeId"].' style="text-decoration:none; color:#000; font-size:0.9em;">'.stripslashes(substr($arrDiscussions['contents'],0,250)).'</a></div>';
