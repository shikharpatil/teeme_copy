...
<div id="container" >
	...
	<div>
		<a href="<?php echo base_url()?>view_chat/chat_view/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1" title="<?php echo $this->lang->line('txt_Close');?>" class="shareCloseIcon">
      ...
      <table width="100%" border="0" cellspacing="3" cellpadding="3">
        ...
        <tr>
          ...
          <td width="85%" align="left" valign="top" class="tdSpace"><div id="showMem" style="height:120px; width:300px; overflow:scroll;">
              <input type="checkbox" id="checkAll" onclick="checkAllFunction();" name="users[]" value="0" <?php if ($arrDiscussionDetails['userId']!=$_SESSION['userId']) { echo 'disabled="disabled"';}?>/>
	...
	var val = '';
		...
		if (1)
		{
			...
			?>
				if (toMatch=='')
				{
					val +=  '<input type="checkbox" id="checkAll" onclick="checkAllFunction();" name="users[]" value="0" <?php if ($arrDiscussionDetails['userId']!=$_SESSION['userId']) { echo 'disabled="disabled"';}?> /><?php echo $this->lang->line('txt_All');?><br>';
				}
			<?php
			}
