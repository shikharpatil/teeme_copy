...
function validate_dis(){
	...
	//Manoj: Commented old code getvalue
	//var getvalue	= getvaluefromEditor('title');
	var getvalue = document.getElementById('title').value;            //Get chat title
  ...
  <div id="content"> 
    ...
    <form name="form1" method="post" action="<?php echo base_url();?>new_chat/start_Chat/<?php echo $pnodeId;?>/0/<?php echo $workSpaceType;?>/type/<?php echo $workSpaceId;?>/<?php echo $linkType;?>">
	 <!--Manoj: added class TextMob and TitleMob-->
      <span class="docLabel "> <?php echo $this->lang->line('txt_Chat_Title');?>: </span> <span class="docTextDiv TextMob">
      <textarea name="title" id="title" class="TitleMob"></textarea>
      </span> 
	   <!--Manoj: Commented chat topic-->
	  <!--<span class="docLabel"> <?php //echo $this->lang->line('txt_Topic');?>: </span> <span class="docTextDiv">
