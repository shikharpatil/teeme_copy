...
function validate_dis(){
	...
	if(!document.form1.title.value){
	  	...
	  	error+='Please Enter a title for discussion.\n';
...
{			
    ...
    <div class="menu_new" >
        ...
        <li class="tag-view_sel" ><a class="active" href="<?php echo base_url()?>view_chat/node1/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/2"  title="<?php echo $this->lang->line('txt_Tag_View');?>"  ></a></li>
    ...
    <div><?php echo $this->lang->line('txt_Tags_Applied');?></div>
    <div>
          <table>
        <?php 
                $arrdispTags = array();
                ...
                {												
                    foreach($treeTags as $key => $arrTagData)
                    {
                        ...
                        {																														
                            $tagLink	= $this->tag_db_manager->getLinkByFinishedChatTags( $tagData['tagId'], $tagData['tag'], $tagData['artifactId'], $tagData['artifactType'] );	
                            if(count($tagLink) > 0)
                            {		
                                if($key == 'simple')
                                {	
