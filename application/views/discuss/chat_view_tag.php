...
<div id="container">
    ...
    <div class="menu_new" >
        ...
        <li class="tag-view_sel" ><a class="active" href="<?php echo base_url()?>view_chat/chat_view/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/3" title="<?php echo $this->lang->line('txt_Tag_View');?>"  ></a></li>
    ...
    <table width="100%">
        ...
        <td  colspan="4"><table>
			...
			$userDetails1	= 	$this->notes_db_manager->getUserDetailsByUserId($arrDiscussionDetails['userId']);		
			...
			if(!empty($discussContributors))
			{
				foreach($discussContributors as $usr){
					$userTags[]="<a href='".base_url()."view_chat/chat_view/".$treeId."/".$workSpaceId."/type/".$workSpaceType."/3/0/0/".$usr['authors']."/'  remUsr='0' class='blue-link-underline userTag tagm'>".$usr['tagName']."</a>";
				}
			}
    ...
    <div id="leaves">
          <?php $this->load->view("discuss/view_chat_tags");?>
        </div>
  </div>
      <!-- Main Body --> 
