...
<!--Manoj: Task showing on click of tags-->
	 <div>
          <input type="button" value="Go" id="go" class="buttonLogin" />  <input type="button" value="Clear" id="clear" class="buttonLogin" />
     </div>
     <div id="leaves">
          <?php  $this->load->view("discuss/view_chat_tags_for_mobile");?>
     </div>
<!--Manoj: code end-->
