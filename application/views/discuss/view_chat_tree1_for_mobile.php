        ...
        <div>
          ...
          <div class="clsNoteTreeHeaderLeft" style="width:70%;">
            ...
            <div id="spanMoveTree" style="float:left; text-align:left" >
              ...
              <div class="lblMoveTree" > Move tree to:</div>&nbsp;&nbsp;<img title="<?php echo  $this->lang->line("txt_Close"); ?>"  src="<?php echo base_url();?>images/close.png" onClick=" hideSpanMoveTree()" style="margin-top:-2px;"  border="0"  /><br />
              <div class="floatLeft">
                <?php   
              ...
              &nbsp;<?php /*?><img title="<?php echo  $this->lang->line("txt_Close"); ?>"  src="<?php echo base_url();?>images/close.png" onClick=" hideSpanMoveTree()" style="margin-top:-2px;"  border="0"  /><?php */?> </div>
...
"; 
          ...
          <div   >
			...
			<div style="float:left;height:30px;max-width:70%;min-width:45%;" class="grayLine"  >
              ...
              <div class=" lblNotesDetails normalView"  id="normalView<?php echo $arrVal['nodeId'];?>"  style="display:none"    >
                <div class="style2"  style="width:100%;" > <?php echo $userDetails1['userTagName'];?>&nbsp;<?php echo $this->time_manager->getUserTimeFromGMTTime($arrVal['DiscussionCreatedDate'], $this->config->item('date_format'));?> </div>
        ...
        <div style="width:960px;  background-color:#FFFFFF;  ">
          <div id="<?php echo $position++;?>" style=" float:left;  " onClick="showNotesNodeOptions(<?php echo $arrVal['nodeId'];?>)" class=" handCursor">
            <?php 
					$viewTags 	= $this->tag_db_manager->getTags(2, $_SESSION['userId'], $arrVal['nodeId'], 2);
					$actTags 	= $this->tag_db_manager->getTags(3, $_SESSION['userId'], $arrVal['nodeId'], 2);
					$contactTags= $this->tag_db_manager->getTags(5, $_SESSION['userId'], $arrVal['nodeId'], 2);
            ...
            <?php
				...
				$nodeTagStatus = 0;		
				?>
            <div style="width:<?php echo $this->config->item('page_width')-50;?>px; float:left;"> </div>
            <span id="spanArtifactLinks<?php echo $arrVal['nodeId'];?>" style="display:none;"></span> <span id="spanTagView<?php echo $arrVal['nodeId'];?>" style="display:none;"> <span id="spanTagViewInner<?php echo $arrVal['nodeId'];?>"> </span> </span>
            <?php	
				#*********************************************** Tags ********************************************************																		
				?>
            <div style="">
...
""; 
                ...
                <div class=" lblNotesDetails normalView"  id="normalView<?php echo $arrVal['nodeId'];?>"  style=" height:15px; width:930px;"    >
                  <div id="normalView<?php echo $arrDiscussions['nodeId']; ?>" class="style2"  style="width:20%; display:none" > <?php echo $userDetails['userTagName'];?>&nbsp;<?php echo $this->time_manager->getUserTimeFromGMTTime($arrDiscussions['DiscussionCreatedDate'], $this->config->item('date_format'));?> </div>
                </div>
                <?php
				#********************************************* Tags ********************************************************88
		...
		?>
              ...
              <?php }?>
              <div  id="reply<?php echo $arrVal['nodeId'];?>" style="width:100%; float:left; display:none;">
