<div class="menu_new" >
	...
	<!--follow and sync icon code start -->
		<ul class="tab_menu_new_for_mobile tab_for_potrait">
			 <li id="treeUpdate" style="float:right;"><img id="updateImage"  src="<?php echo base_url()?>images/new-version.png" onClick="window.location=('<?php echo base_url()?>view_chat/chat_view/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1')" style=" cursor:pointer" ></li>
