          ...
          <td align="left" valign="top" bgcolor="#FFFFFF">
			...
			<tr>
                	...
                	<ul class="rtabs">
                		...
                		<li><a href="<?php echo base_url()?>workspace_home2/trees/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" class="current"><span><?php echo $this->lang->line('txt_Recent_Trees');?></span></a></li>
            			...
            			<li><a href="<?php echo base_url()?>workspace_home2/tasks/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><span><?php echo $this->lang->line('txt_Applied_Tasks');?></span></a></li>

						<li><a href="<?php echo base_url()?>workspace_home2/talks/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><span><?php echo $this->lang->line('txt_Recent_Talks');?></span></a></li>

            			<li><a href="<?php echo base_url()?>workspace_home2/files/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><span><?php echo $this->lang->line('txt_Recent_Files');?></span></a></li>                            
