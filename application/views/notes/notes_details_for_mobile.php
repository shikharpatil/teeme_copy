		...
		<div id="content">
			...
			<div class="menu_new" >
							...
							<ul class="tab_menu_new_for_mobile tab_for_potrait">
								 <li style="float:right;"><img  id="updateImage" src="<?php echo base_url()?>images/new-version.png" onclick="window.location='<?php echo base_url()?>notes/Details/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1'" title="<?php echo $this->lang->line('txt_Notes_View');?>" style=" cursor:pointer" ></li>
...
"; 
						...
						<li  ><a id="liLink0"  class="link disblock" onclick="getElementById('ulTreeOption').style.display='none';showPopWin('<?php echo base_url(); ?>show_artifact_links/index/<?php echo $treeId; ?>/1/<?php echo $workSpaceId; ?>/<?php echo  $workSpaceType; ?>/1/0/1', 680, 380, null, '');" alt="<?php echo $this->lang->line("txt_Links"); ?>" title="<?php echo html_entity_decode(strip_tags($appliedLinks,'')); ?>" border="0" ><strong><?php echo $total; ?></strong></a></li>		
		...
		<!-- -------------------------------------------------move tree code close here -------------------------------------------------------------- -->	
						  ...
						  <div style="height:20px;">
							...
							<div class="style2" style="width:100%; text-align:left; margin-left:2%;">

							 
					<div>
					<?php 
						echo $arrUser['tagName'];
					    if(strlen($arrUser['tagName'])>24)
						{
					  ?>
					...
					//Start Manoj: Remove date suffix and current year
					 ...
					 //echo ' '.$this->time_manager->getUserTimeFromGMTTime($treeDetail['editedDate'], $this->config->item('date_format'));
							...
							<a href="javascript:void(0);"  onClick="openEditTitleBox('<?php echo $treeId; ?>','');"  style="float:right" ><img src="<?php echo base_url(); ?>images/editnew.png" alt="<?php echo $this->lang->line("txt_Edit"); ?>" title="<?php echo  $this->lang->line("txt_Edit"); ?>" border="0"></a>
					...
					<div id="0notes"   style="width:100%; float:left; display:none;" >
						...
						<form name="form10" id="form10" method="post" action="<?php echo base_url();?>notes/addMyNotes/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>">
							...
							<div id="audioRecordBox"><div style="float:left;margin-top:5px"><span id="drop"><a title="Record an audio" style="margin-left:0%; cursor:pointer;" onClick="startAudioRecord(1,'');"><span class="fa fa-microphon"></span></a></span></div><div id="1audio_record" style="display:none; margin-left:2%; margin-top:0.4%; float:left;"></div></div>
...
"; 
							...
							<li  ><a id="liLink<?php echo $arrVal['nodeId']; ?>" class="link disblock" onclick="showPopWin('<?php echo base_url(); ?>show_artifact_links/index/<?php echo $arrVal['nodeId']; ?>/2/<?php echo $workSpaceId; ?>/<?php echo  $workSpaceType; ?>/2/1/1', 680, 380, null, '');" alt="<?php echo $this->lang->line("txt_Links"); ?>" title="<?php echo html_entity_decode(strip_tags($appliedLinks)); ?>" border="0" ><strong><?php echo $total; ?></strong></a></li>	
						...
						<?php
							...
							{	
							 ...
							 /*<!--Changed by Surbhi IV -->	*/
								...
								//echo ' <li  class="talk"><a id="liTalk'.$leafTreeId.'" href="javaScript:void(0)"  onClick="window.open(\''.base_url() .'view_talk_tree/node/' .$leafTreeId .'/'. $workSpaceId.'/type/'.$workSpaceType.'/ptid/'.$treeId.'\' ,\'\',\'width=850,height=600,scrollbars=yes\') " title="'.strip_tags($arrVal['contents']).'" border="0" >'.$total.'</a></li>';
				   ...
				   <div class="clr"></div> 
					...
					<div onClick="showNotesNodeOptions(<?php echo $arrVal['nodeId'];?>);"  >   
							...
							<div style="height:30px;" > 
							 ...
							 <div class="style2" style="margin: 4%; width: 100%; text-align:left;" >

                             
							<div>
							 <?php 
							   echo $userDetails1['userTagName'];
							   if(strlen($userDetails1['userTagName'])>26)
		  					   {
							 ?> 
						...
						?> 
							...
							<div class="editDocumentOption <?php if (in_array($_SESSION['userId'],$contributorsUserId)) {echo "disblock2" ;}else { echo "disnone2" ; } ?> "  style="float:none; padding: 13% 0%;" >

						<!--Changed by Surbhi IV -->

                             <span style="float:left;"><a style="margin-right:25px;"  href="javascript:addLeaf(<?php echo $arrVal['leafid'];?>,<?php echo $treeId;?>,<?php echo $position;?>,<?php echo $arrVal['nodeId'];?>,<?php echo $arrVal['successors'];?>);"><img src="<?php echo  base_url(); ?>images/addnew.png"  title="<?php echo $this->lang->line("txt_Add"); ?>" border="0" ></a></span>

                             <!--End of Changed by Surbhi IV -->
						<span style="float:right;">
						<a href="javascript:editNotesContents_1(<?php echo $position;?>,<?php echo $focusId;?>,<?php echo $treeId;?>,<?php echo $workSpaceId;?>,<?php echo $workSpaceType;?>,<?php echo $arrVal['nodeId'];?>,'<?php echo $this->lang->line('txt_Done');?>',<?php echo $arrVal['successors'];?>,<?php echo $arrVal['leafid'];?>)" ><img src="<?php echo  base_url(); ?>images/editnew.png" alt="<?php echo $this->lang->line("txt_Edit"); ?>" title="<?php echo $this->lang->line("txt_Edit"); ?>" border="0"></a>
						</span>	
