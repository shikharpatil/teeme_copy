          ...
          <tr>
			...
			?>
						<tr class="rowHeading header">	
							...
							<td width="45%"><span><a href="<?php echo base_url();?>chat/index/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1"><?php echo $this->lang->line('txt_Chat');?></a></span></td>
							<td width="30%"><span><a href="<?php echo base_url();?>chat/index/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/2"><?php echo $this->lang->line('txt_Created_By');?></a></span></td>
							<td width="23%"><span><a href="<?php echo base_url();?>chat/index/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/3"><?php echo $this->lang->line('txt_Modified_Date');?></a></span></td>
	...
	$i = 1;
      ...
      <tr class="<?php echo $rowColor;?>">
        <td align="left" colspan="2">
			...
			{
			?>
            	<img src="<?php echo base_url();?>images/icon_Green.gif" alt="Running" title="Running" border="0"/>
<a href="<?php echo base_url();?>view_chat/chat_view/<?php echo $keyVal;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><?php echo strip_tags($arrVal['name']);?>
            <?php
			}
			else
			{
			?>
            	<img src="<?php echo base_url();?>images/icon_Red.gif" alt="Stopped" title="Stopped" border="0"/>
				<a href="<?php echo base_url();?>view_chat/node1/<?php echo $keyVal;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><?php echo strip_tags($arrVal['name']);
			}
			?>
            <?php
