    ...
    <div id="right">
      ...
      <ul>
        ...
        <li class="unbordered">
          ...
          <a href="<?php echo base_url();?>admin/admin_logout/work_place"><span id="logoutTxt"><?php echo $this->lang->line('txt_Sign_Out');?></span> <img class="" style="height: 36px;margin-top: 5px;padding: 7px 0 7px 12px;width: 36px;border: medium none;float: right;" src="<?php echo base_url();?>images/logout.png" ></a>
