...
<table width="<?php echo $this->config->item('page_width');?>" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#D9E3F2">
    ...
    <td valign="top"><table width="<?php echo $this->config->item('page_width')-25;?>" border="0" align="center" cellpadding="0" cellspacing="0">
		...
		?>
                    <tr>
                      <td align="left" class="bg-grey-img"><span class="heading-grey"><a href="<?php echo base_url();?>discussion/index/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/1"><?php echo $this->lang->line('txt_Topic');?></a></span></td>
                      <td  class="bg-grey-img"><span class="heading-grey"><a href="<?php echo base_url();?>discussion/index/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/2"><?php echo $this->lang->line('txt_Originator');?></a></span></td>
                      <td  class="bg-grey-img"><span class="heading-grey"><a href="<?php echo base_url();?>discussion/index/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/3"><?php echo $this->lang->line('txt_Modified_Date');?></a></span></td>
                    </tr>
                    <?php
	...
	echo form_open('', $attributes);
		...
		?>
                    <tr>
                      <td align="left" valign="top"  class="bg-white"><a class="blue-link-underline" href="<?php echo base_url();?>view_discussion/node/<?php echo $keyVal;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><?php echo $arrVal['name'];?> </a></td>
	...
	?>
                    <tr>
                      <td align="left" valign="top" class="bg-white" colspan="3"><span class="infoMsg"><?php echo $this->lang->line('txt_None');?></span></td>
                    </tr>
                    <?php
	}	
