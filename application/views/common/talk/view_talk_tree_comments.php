...
<script>
   ...
   if (year1 > year2) return 1;
	...
	function validate_dis_talk(replyDiscussion,formname){
	var error='';
...
<?php /*?></head><body style="background-color:#FFFFFF;"><?php */?>
...
<?php	
	$focusId = 2;
	$realTimeTalkCommentDivIds = array();
	$totalNodes = array();
	$totalTalkNodes = array();
	$rowColor1='rowColor3';
	$rowColor2='rowColor4';	
...
?>
<input type="hidden" name="talkCount" id="talkCount" value="<?php echo $count; ?>">
<input type="hidden" id="totalTalkNodes<?php echo $treeId; ?>" value="<?php echo implode(',',$totalTalkNodes);?>">
