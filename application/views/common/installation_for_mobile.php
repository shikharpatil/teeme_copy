...
<form name="frmInstallation" id="frmInstallation" action="<?php echo base_url();?>installation" method="post" enctype="multipart/form-data">
    ...
    <?php /*?><div class="clsMarginBottom10" ><span class="error"><?php echo $_SESSION['errorMsg']; $_SESSION['errorMsg'] ='';unset( $_SESSION['errorMsg']);?></span></div><?php */?>
        ...
        <div class="clsMarginBottom10"> 
                        ...
                        <div class="flLt"> <input name="server" class="text_gre1" id="server" size="" value="<?php echo base64_decode ($this->config->item('hostname')); ?>"/></div>
						 <div class='clr' ></div>  

                        <div class="flLt"><?php echo $this->lang->line('database_server_user'); ?><span class="text_red">*</span></div>

                            <div class="flLt"><input name="server_username" class="text_gre1" id="server_username" size="" value="<?php echo base64_decode ($this->config->item('username')); ?>"/></div>
						<div class='clr' ></div> 	
						<div class="flLt"><?php echo $this->lang->line('database_server_password'); ?><span class="text_red">*</span></div>

                            <div class="flLt"><input name="server_password" class="text_gre1" type="password" id="server_password" size="" value="<?php echo base64_decode ($this->config->item('password')); ?>"/></div>
<div class='clr' ></div> 
                        <div class="flLt"><?php echo $this->lang->line('database_name'); ?><span class="text_red">*</span></div>
               

                            <div class="flLt"><input name="instance_name" type="text" id="instance_name" size="" value="<?php echo $this->config->item('instanceName');?>"/></div>
						<div class='clr' ></div> 
						
						<!--Manoj: Added auto update path url field-->
						
						<div class="flLt"><?php echo $this->lang->line('auto_update_server_path'); ?><span class="text_red">*</span></div>
               

                            <div class="flLt"><input name="autoupdate_path" type="text" id="autoupdate_path" size="" value="<?php echo $this->config->item('auto_update_client_path');?>"/></div>
						<div class='clr' ></div> 
