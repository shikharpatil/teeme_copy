...
$viewTags = $this->tag_db_manager->getTagsByCategoryId(1);
?>
...
<tr>
		<td align="left" class="bg-light-blue"><?php echo $this->lang->line('txt_Tags');?></td>
...
if(count($viewTags) > 0)
{
	...
	<?PHP 
		$tags = $this->tag_db_manager->getTagsByTagType(1, $tagTypeData['tagTypeId'], $_SESSION['userId']);	         	
		if(count($tags) > 0)
		{
