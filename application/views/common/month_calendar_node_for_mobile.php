  ...
  <tr>
	<td><table width="100%" border="0" cellpadding="0" cellspacing="0">
		<tr class="bg-light-blue-txt-white">		
		  ...
		  <td width="11%" align="center">Tues</td>
		  <td width="11%" align="center">Wed</td>
		  <td width="13%" align="center">Thu</td>
		  <td width="11%" align="center">Fri</td>
		  <td width="14%" align="center">Sat</td>
		  <td width="13%" align="center">Sun</td>
		</tr>
	</table></td>
  </tr>
  <tr>
