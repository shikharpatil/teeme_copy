			...
			<table width="100%" cellpadding="0" cellspacing="1">
				<tr  >
					...
					<form name="frmTag0" method="post" action="<?php echo base_url();?>show_artifact_links/apply">
                    	...
                    	<input type="radio" name="tree" value="7" onClick="selectLinks(this,<?php echo $linkSpanOrder;?>)" <?php if($impShow==1){ ?> checked="checked" <?php } ?> ><?php echo $this->lang->line('txt_Imported_Files');?>
