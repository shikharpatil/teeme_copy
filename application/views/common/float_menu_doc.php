...
<table width="4%" border="0" cellpadding="0" cellspacing="0" class="bg-light-grey2">
              <tr>
            	...
            	<img src="<?php echo base_url();?>images/bold.jpg" name="Boldcmd" hspace="4" vspace="3" height="19" width="23" border="0" class="editorCursor" id="Boldcmd" onClick="Bold_cmd();" alt="Bold"><img  src="<?php echo base_url();?>images/italic.jpg" name="Italiccmd" hspace="4" vspace="3" height="19" width="23" border="0" class="editorCursor" id="Italiccmd" onClick="Italic_cmd();" alt="Italic"><br />
					<img  src="<?php echo base_url();?>images/underline.jpg" name="Underlinecmd" hspace="4" vspace="3" border="0" height="19" width="23" class="editorCursor" id="Underlinecmd" onClick="Underline_cmd();" alt="Underline"><img src="<?php echo base_url();?>images/copy.jpg" name="Copycmd" height="19" width="23" hspace="4" vspace="3" border="0" class="editorCursor" id="Copycmd" onClick="Copy_cmd();" alt="Copy"><br />
				...
				<img src="<?php echo base_url();?>images/del.jpg" name="Cutcmd" hspace="4" border="0" class="editorCursor" id="Cutcmd" onClick="Cut_cmd();" alt="Cut" height="19" width="23"  vspace="3"><img src="<?php echo base_url();?>images/paste.jpg" name="Pastecmd" hspace="4" border="0" class="editorCursor" id="Pastecmd" onClick="Paste_cmd();" alt="Paste" height="19" width="23"  vspace="3"><br />
              ...
              <tr>
                <td height="8" class="border-bottm-grey">&nbsp;</td>
              </tr>
              <tr>
                <td align="left" valign="top"> <span id="saveOption">
                  ...
                  <tr>
                    <td colspan="2" align="center"><a href="#" onClick="return saveDocument()"><img src="<?php echo base_url();?>images/done-btn.jpg" border="0" /></a></td>
                  </tr>
                  <tr>
                    <td colspan="2" align="center"><a href="<?php echo base_url();?>document_home/index/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><img src="<?php echo base_url();?>images/btn-cancel.jpg" width="52" height="16" border="0" /></a></td>
                  </tr>
