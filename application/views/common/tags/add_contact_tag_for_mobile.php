...
<table width="100%" border="0" cellspacing="0" cellpadding="5" align="center" >
  <tr>
    <td><form name="frmTagContact0" method="post" action="<?php echo base_url();?>create_tag1">
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="5" align="center">
          ...
          <tr>
            <td><input type="text" id="searchTagsContact" name="searchTagsContact" onkeyup="search_contact_tags_contact()" size="25"/></td>
          </tr>
          <tr>
            <td valign="top" width="20%"><?php echo $this->lang->line('txt_Tag_List');?>: </td>
          </tr>
          <tr>
            <td><div id="divshowTagsContact" style="display:block; overflow: auto ; height:170px; scrollbar-arrow-color:blue; scrollbar-face-color: #e7e7e7; scrollbar-3dlight-color: #a0a0a0; scrollbar-darkshadow-color:#888888">
                <?php
			$count = '';
			$sectionChecked = '';
