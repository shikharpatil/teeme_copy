...
<div class="boxtext">
    ...
    <ul class="tab_tag_link">
              ...
              <?php 
			 //echo $leafAlertNo.'==='.$leafAlertMsg.'=='.$leafDraftReserveStatus.'=='.$treeType;
			 //echo $latestVersion.'==='.$latestTreeVersion.'==='.$artifactType;
			 //echo $nodeSuccessor.'=='.$currentLeafStatus.'=='.$treeType.'=='.$latestVersion.'=='.$latestTreeVersion.'=='.$artifactType.'=='.$currentTreeId.'=='.$spaceMoved.'=='.$leafDraftReserveStatus;
