...
<form name="frmTag" method="post" action="<?php echo base_url();?>create_tag2" onSubmit="return validateTag()">
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="background-color:#E9F3FC;" align="center" class="blue-border">
    ...
    <tr>
      <td align="left" valign="middle"><?php echo $this->lang->line('txt_Comments');?></td>
...
?>
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><input name="confirm" type="Submit" class="button" value="<?php echo $this->lang->line('txt_Done');?>"/>
        <input name="add_more" type="Submit" class="button" value="<?php echo $this->lang->line('txt_Add_More');?>" onClick="updateSequence()"/>
