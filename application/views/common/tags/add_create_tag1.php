...
<form name="frmTag" method="post" action="<?php echo base_url();?>create_tag2" onSubmit="return validateTag()">
  <table width="100%" border="0" cellspacing="0" cellpadding="5" style="background-color:#E9F3FC" align="center" class="blue-border">
    ...
    <tr>
      ...
      <td colspan="2" align="left" valign="top"><input type="text" name="tagComments"></td>
    </tr>
    <tr>
      <td width="30%" align="left" valign="middle"><?php echo $this->lang->line('msg_task_create');?></td>
      <td colspan="2" align="left" valign="top"><select name="tag" id="tag">
          <?php
			$i = 0;	
    ...
    <tr>
      ...
      <td colspan="2" align="left" valign="top"><select name="taggedUsers[]" multiple>
          ...
          <option value="0"><?php echo $this->lang->line('txt_Task_All');?></option>
          <?php	
    ...
    <tr>
      <td>&nbsp;</td>
      <td colspan="2"><input name="confirm" type="Submit" class="button" value="<?php echo $this->lang->line('txt_Apply');?>"/>
