<?php /*Copyright © 2008-2014. Team Beyond Borders Pty Ltd. All rights reserved.*/ ?><form name="frmTag" method="post" action="<?php echo base_url();?>create_tag1" onSubmit="return validateTag()"> 
<table width="100%" border="0" cellspacing="0" cellpadding="5" style="background-color:#E9F3FC;" align="center" class="blue-border">
	<tr>
		<td height="8" colspan="3"></td>
	</tr> 	
	<tr>
	<td width="30%" align="left" valign="middle"><?php echo $this->lang->line('txt_Enter_Tag');?></td>
