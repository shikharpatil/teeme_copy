...
<div id="rightSideBar">
		...
		<?php
         ...
         <?php 
         	$treeName = $this->identity_db_manager->getTreeNameByTreeId($treeId);
         ...
         <div id="divSeed" class="seedBackgroundColorNew shareSeedDivHeight" >
       		...
       		<div class="clsNoteTreeHeader handCursor"> 
       			<?php 
				if($treeName != 'untitled')
				{
				?>
					<?php echo strip_tags($treeName);?>
		...
		<?php
			...
			<?php
			/*
				<li class="task-day-view"><a  href="<?php echo base_url()?>calendar/index/3/<?php echo $day;?>/<?php echo $month;?>/<?php echo $year;?>/<?php echo $workSpaceId;?>/<?php echo $workSpaceType;?>/<?php echo $artifactType;?>/<?php echo $artifactTreeId;?>" <?php if($option == 3) { ?>class="active" <?php } ?> ><span>Day View</span></a></li>
				
				<li class="task-time-view"><a href="<?php echo base_url()?>calendar/index/2/<?php echo $day;?>/<?php echo $month;?>/<?php echo $year;?>/<?php echo $workSpaceId;?>/<?php echo $workSpaceType;?>/<?php echo $artifactType;?>/<?php echo $artifactTreeId;?>" <?php if($option == 2) { ?>class="active" <?php } ?> title="Week View"><span>Week View</span></a></li>
			*/
			?>
				
				<li class="task-month-view " ><a href="<?php echo base_url()?>calendar/index/1/<?php echo $day;?>/<?php echo $month;?>/<?php echo $year;?>/<?php echo $workSpaceId;?>/<?php echo $workSpaceType;?>/<?php echo $artifactType;?>/<?php echo $artifactTreeId;?>" <?php if($option == 1) { ?>class="active" <?php } ?> title="Month View"><?php echo $this->lang->line('month_view'); ?></a></li>		
              ...
              <tr>
				...
				switch($option)
				{
					case 1:
						...
						{										
							$arrCalDetails['artifactTreeId'] = $artifactTreeId;
							$this->load->view('common/month_calendar_node', $arrCalDetails); 
						}
						else
						{
							$arrCalDetails['artifactTreeId'] = $artifactTreeId;
