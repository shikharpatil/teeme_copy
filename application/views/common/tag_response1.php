<?php /*Copyright © 2008-2014. Team Beyond Borders Pty Ltd. All rights reserved.*/ ?><form name="frmTagResponse" method="post" action="<?php echo base_url();?>tag_response">
<table width="95%" border="0" cellspacing="0" cellpadding="5" >
	...
	?>  
	<tr>
		<td width="35%" align="left" valign="middle" colspan="3"><span class="text_blue"><strong><?php echo $tagDetail['tagComments'];?> </strong></span></td>
	  
	</tr> 
	<?php
	if($tagDetail['tagType'] != 'Comment')
	{
	?>    
	<tr>
	...
	<tr>
	  <td>&nbsp;</td>
		<td colspan="2">
			...
			<input type="hidden" name="responseOption" value="2">		
