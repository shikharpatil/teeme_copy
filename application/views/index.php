...
define('ADMIN_USERNAME','teeme'); 	// Admin Username
...
// The correct directory path is set by reverse procy server. Thus the script should not append the directory -- AG 24 April 2010
