				...
				<!-- Main Body -->
                    ...
                    <tr>
                      <td class="subHeading" colspan="4">
						<form name="frmTopic" action="<?php echo base_url().'admin/admin_help/create_lang_topic/'.$topicId;?>" method="post">
                        ...
                        <tbody>
						 <tr>
                            ...
                            <td width="512" align="left" valign="top" class="text_gre1">
                                <?php echo $arrTopics ['topicName'];?>                   
                            </td>
                          </tr>
                          <tr>
                            <td width="179" align="left" valign="middle"><?php echo $this->lang->line('txt_Language');?><span class="text_red">*</span></td>
                            <td align="center" valign="middle" class="text_gre">&nbsp;</td>
                            <td align="left" valign="top" class="text_gre1">
							
							<select  name="langCode">								<?php
								foreach($languages as $key=>$lang)
								{
									if(!in_array($key, $langCodes))
									{
									?>
									  <option value="<?php echo $key;?>" selected="selected"><?php echo $lang;?></option>		
								<?php	
									}			
								}			
								?>			
                          ...
                          <tr>
                            ...
                            <td width="5" align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                            <td width="512" align="left" valign="top" class="text_gre1">
                              <input name="topic" class="text_gre1" id="topic" size="30" />                             
                            </td>
                          </tr>
