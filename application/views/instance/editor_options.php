                  ...
                  <td align="left" valign="top">
					...
					<tr>
                        <td colspan="2" align="left" valign="top" class="tdSpace">
                        	<ul class="rtabs">
                				<li><a href="<?php echo base_url()?>instance/home/select_editor"><span>Select Editor</span></a></li>
                				<li><a href="<?php echo base_url()?>instance/home/editor_options/tinyadvance" <?php if ($editorName=='tinyadvance') {echo 'class=current';}?>><span>Tiny Advance</span></a></li>
								<li><a href="<?php echo base_url()?>instance/home/editor_options/tinysimple" <?php if ($editorName=='tinysimple') {echo 'class=current';}?>><span>Tiny Simple</span></a></li>
            					<li><a href="<?php echo base_url()?>instance/home/editor_options/fckadvance" <?php if ($editorName=='fckadvance') {echo 'class=current';}?>><span>FCK Advance</span></a></li>
            					<li><a href="<?php echo base_url()?>instance/home/editor_options/fcksimple" <?php if ($editorName=='fcksimple') {echo 'class=current';}?>><span>FCK Simple</span></a></li>
            				</ul>
                        </td>
					</tr>
