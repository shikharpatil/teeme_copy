          ...
          <tr>
                    ...
                    <table width="100%" border="0" cellpadding="3" cellspacing="0" bordercolor="#111111" class="text_gre1" id="table12" style="border-collapse: collapse;">
                        ...
                        <tr>
                          ...
                          <td width="302" align="left" class="text_gre">
                            ...
                            <input name="first_name" class="text_gre1" id="first_name" value=""/>
							</td>
                        ...
                        <tr>
                          ...
                          <td width="302" align="left" class="text_gre">
                            ...
                            <input name="last_name" class="text_gre1" id="last_name"  value=""/>
							</td>
                        ...
                        <tr>
                          ...
                          <td width="302" align="left" class="text_gre">
                            ...
                            <input name="userName" class="text_gre1" id="userName"  value=""/>
            ...
            &nbsp;<span id="workPlaceStatusText"></span> </td>
                      ...
                      <?php /*?><tbody>
                        ...
                        <tr>
                          ...
                          <td width="163" align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Email');?> </td>
            ...
            &nbsp;<span id="workPlaceStatusText"></span> </td>
                        ...
                        <tr>
                          ...
                          <td align="left" class="text_gre" valign="top"><input type="password" name="password" class="text_gre1" id="password" value="" /></td>

                        </tr>

                        <tr>

                          <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Confirm_Password');?></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" class="text_gre" valign="top"><input type="password" name="confirmPassword" class="text_gre1" id="confirmPassword" value="" /></td>

                        </tr>         

                        <tr>

                          <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Security_Question');?></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" class="text_gre" valign="top">

                          	<select name="securityQuestion" class="text_gre1" id="securityQuestion" style="width:80%;"/>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="top" class="text_gre1"><?php echo $this->lang->line('txt_Answer');?></td>

                          <td align="center" valign="top" class="text_gre"><strong>:</strong></td>

                          <td align="left" class="text_gre" valign="top"><input type="text" name="securityAnswer" id="securityAnswer" value="" /></td>
                ...
                <tr>
                  ...
                  <td width="302" align="left" class="text_gre">
				       <input type="submit" name="Submit" class="button01" value="<?php echo $this->lang->line('txt_Done');?>">
				   
				   	   <input type="button" name="Cancel" value="<?php echo $this->lang->line('txt_Cancel');?>" onClick="javascript:history.go(-1)">	
				  </td>

                 <?php /*?> <td colspan="2" width="46%">&nbsp;</td>
