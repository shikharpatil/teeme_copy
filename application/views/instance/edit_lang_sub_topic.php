				...
				<!-- Main Body -->
                    ...
                    <tr>
                      <td class="subHeading" colspan="4">
						<form name="frmTopic" action="<?php echo base_url().'admin/admin_help/edit_lang_sub_topic/'.$subTopicId;?>/<?php echo strtolower($langCode);?>" method="post">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td width="512" align="left" valign="top" class="text_gre1">
                              <input name="subTopic" class="text_gre1" id="topic" size="30" value="<?php echo $arrLangSubTopics['subTopicText'];?>"/>                             
                            </td>
                          </tr>
						 <tr>
                            <td width="179" align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_Contents');?>:<span class="text_red">*</span></td>
                            <td width="5" align="center" valign="middle" class="text_gre"><strong>:</strong></td>
                            <td width="512" align="left" valign="top" class="text_gre1">
                              <span class="text_gre">
                              <textarea name="contents" cols="60" rows="7" id="contents"><?php echo $arrLangSubTopics['contents'];?></textarea>
                              </span>                            </td>
                          </tr>		
                          <tr>
