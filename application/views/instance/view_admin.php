          ...
          <tr>
			...
			?>
              ...
              <tr>
                ...
                <td><?php if ($adminData['adminFirstName']!=''){ echo $adminData['adminFirstName']; }?> <?php if ($adminData['adminLastName']!=''){ echo $adminData['adminLastName']; }?> <?php if($adminData['adminFirstName']!='' || $adminData['adminLastName']!='') {?>(<?php } ?><?php echo $adminData['adminUserName'];?><?php if($adminData['adminFirstName']!='' || $adminData['adminLastName']!='') {?>)<?php } ?></td>               
