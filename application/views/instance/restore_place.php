                  ...
                  <td align="left" valign="top">
                    ...
                    <tr>
                		...
                		<td colspan="5" align="left">
							...
							<br /><br />
							<input type="submit" name="restore" value="upload" onclick="document.getElementById('please_wait').style.display='';"  />
							</form>
                    

							<span id="please_wait" style="display:none;">
	
								Please wait while the place is being restored. Don't refresh or close this page. This could take a while.....
