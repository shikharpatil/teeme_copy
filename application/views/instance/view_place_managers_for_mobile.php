...
?>
			...
			<?php /*?><div id="container" style="padding:0px 0px 0px">
				...
				<div id="content"><?php */?>
                                    ...
                                    <table width="100%" border="0" >
                                        ...
                                        <tr>
                                            <td align="left" valign="top" colspan="5" class="tdSpace">
                                                                    	<div class="menu_new" >
		...
		?>
			...
			?>
              ...
              <div class="flLt memberMobileView" style="margin-top:1%;"><?php echo $placeManagerData['firstName'].' '.$placeManagerData['lastName'];?></div>

       <div class="flLt memberMobileView" style="margin-left:3%; margin-top:1%;">       <?php echo ($placeManagerData['tagName'])?$placeManagerData['tagName']:"&nbsp;";?></div>


              <div class="flLt" style="margin-left:3%; margin-top:1%;">
