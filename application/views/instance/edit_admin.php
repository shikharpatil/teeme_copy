          ...
          <tr>
			...
			<div class="clr"></div>
                ...
                <tr>
                  ...
                  <td class="subHeading" colspan="4"><?php echo $this->lang->line('edit_admin_details'); ?></td>
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td width="302" align="left" class="text_gre">
                            ...
                            <input name="first_name" class="text_gre1" id="first_name" size="30" value="<?php echo $adminDetails['adminFirstName']?>"/>
							</td>
                        ...
                        <tr>
                          ...
                          <td width="302" align="left" class="text_gre">
                            ...
                            <input name="last_name" class="text_gre1" id="last_name" size="30" value="<?php echo $adminDetails['adminLastName']?>"/>
							</td>
                        ...
                        <tr>
                          ...
                          <td width="302" align="left" class="text_gre">
							...
							<input type="username"name="username" class="text_gre1" id="username" size="30" value="<?php echo $adminDetails['adminUserName'];?>" />
