          ...
          <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
              ...
              <tr>
                ...
                <td align="left" class="subHeading"><?php echo $this->lang->line('txt_Change_Password_Mobile');?></td>
              ...
              <tr>
                ...
                <td height="12 px" align="left" class="tdSpace"><span class="errorMsg" id="err"><?php echo $_SESSION['errorMsg']; $_SESSION['errorMsg'] ='';?></span></td>
              ...
              <tr>
                ...
                <td align="center" valign="top">
                  ...
                  <form name="frmchangepass" method="post" action="<?php echo base_url();?>instance/home/update_password" onsubmit="return validatePass()">
                    ...
                    <table width="95%" border="0" cellpadding="1" cellspacing="2" bordercolor="#111111" class="text_gre1" id="table12" style="border-collapse: collapse;">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_Current_Password');?> </td>
                        ...
                        <tr>
                          ...
                          <td align="left" valign="middle" class="text_gre1"><?php echo $this->lang->line('txt_Confirm_Password_New');?> </td>
