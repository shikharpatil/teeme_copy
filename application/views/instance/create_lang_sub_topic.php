				...
				<!-- Main Body -->
                    ...
                    <tr>
                      <td class="subHeading" colspan="4">
						<form name="frmTopic" action="<?php echo base_url().'admin/admin_help/create_lang_sub_topic/'.$subTopicId;?>" method="post">
                        ...
                        <tbody>
                          <tr>
                            <td width="179" align="left" valign="middle"><?php echo $this->lang->line('txt_Select_Language');?>:<span class="text_red">*</span></td>
                          ...
                          <tr>
                            ...
                            <td width="512" align="left" valign="top" class="text_gre1">
                              <input name="subTopic" class="text_gre1" id="subTopic" size="30" />                             
                            </td>
                          </tr>
							   <tr>
                            ...
                            <td width="512" align="left" valign="top" class="text_gre1">
                              <span class="text_gre">
                              <textarea name="contents" cols="60" rows="7" id="contents"></textarea>
                              </span>                            </td>
                          </tr>	
                          <tr>
