...
<form name="form3<?php echo $leafId;?>" id="form3<?php echo $leafId;?>" method="post" action="<?php echo base_url();?>new_task/leaf_edit_Task/<?php echo $leafId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>">
		...
		<div class="subTaskMobile" id="divedittast<?php echo $leafId;?>" ><?php echo "Title";?>:</div>
	...
	?>
		...
		<div class="subTaskMobile">
			...
			<input name="starttime" data-field="datetime" class="date-input-start" type="text" id="starttime<?php echo $leafId;?>"  value="<?php echo $editStartTime;?>" <?php echo $editStartTimeStyle;?> readonly >
    ...
    <?php
		...
		<div class="subTaskMobile">
        	...
        	<img src="<?php echo base_url();?>images/rednew.png" style="margin-right:5px;"  border="none" alt="<?php echo $this->lang->line('txt_End_Time');?>" /><?php echo $this->lang->line('txt_End_Time');?>:
			...
			<input name="endtime" type="text" id="endtime<?php echo $leafId;?>" data-field="datetime" class="date-input-end"  value="<?php echo $editEndTime;?>"  <?php echo $editEndTimeStyle;?>  readonly >
...
<div class="subTaskMobile fieldsetBottom" >
	...
	<div class="clr"></div>
    		...
    		<div id="showMemEditSubTask<?php echo $nodeId ;?>" class="showMem1">
            	...
            	<input type="checkbox" name="taskUsers[]" value="<?php echo $_SESSION['userId'];?>" <?php if (in_array($_SESSION['userId'],$taskUsers)) { echo 'checked="checked"';}?>/> <span><?php echo $this->lang->line('txt_Me');?></span>           
			...
			?>
            		...
            		<input type="checkbox" name="taskUsers[]" value="0"/> <span><?php echo $this->lang->line('txt_All');?></span>
            ...
            <button class="button01" onclick="assignTo(<?php echo $nodeId;?>);">Ok</button> 
	...
	?>
			...
			<div class="subTaskMobile">
				...
				<input type="button" name="Replybutton" value="<?php echo $this->lang->line('txt_Add'); //echo $this->lang->line('txt_Done');?>" onClick="validateSubTaskEdit11('edittask<?php echo $leafId;?>',document.form3<?php echo $leafId;?>,<?php echo $leafId;?>,<?php echo $nodeId; ?>);" class="button01"> &nbsp;&nbsp;&nbsp;&nbsp;
				...
				<input type="reset" name="Replybutton1" value="<?php echo $this->lang->line('txt_Cancel');?>" onClick="hideTaskView1New(<?php echo $leafId;?>);" class="button01">
...
function validateSubTaskEdit11(replyDiscussion,formname,leafId){ 
