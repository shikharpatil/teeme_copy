...
function validate_task(replyDiscussion,formname){
	...
	<table width="100%">
          ...
          <tr>
			...
			<table width="100%">
				...
				<td align="left"><a href="<?php echo base_url();?>view_task/node/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" style="text-decoration:none;"><img src="<?php echo base_url();?>images/empty-tri.gif" alt="Home" border="0"></a>
...

				{
...

					{
						...
						<a href="<?php echo base_url();?>view_task/node_task/<?php echo $_SESSION['nodes'][$i];?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" style="text-decoration:none;"><img src="<?php echo base_url();?>images/fill-tri.gif" alt="<?php echo $i+1;?>" border="0"></a>
      ...
      <tr>
		...
		<?php 
				...
				$userDetails	= $this->task_db_manager->getUserDetailsByUserId($arrparent['userId']);

				$checkPre =$this->task_db_manager->checkPredecessor($arrparent['nodeId']);

				$arrActivities = array('Not Completed', '25% Completed', '50% Completed', '75% Completed', 'Completed');

				$arrNodeTaskUsers 	= $this->task_db_manager->getTaskUsers($arrparent['nodeId'], 2);

				$nodeTaskStatus 	= $this->task_db_manager->getTaskStatus($arrparent['nodeId']);

				$contributors 				= $this->task_db_manager->getTaskContributors($arrparent['nodeId']);
...

				{
					...
					$arrNodes = $this->task_db_manager->getNodesBySuccessor($arrparent['successors']);					

					$allNodes = implode(',', $arrNodes);

					$listTime = $this->task_db_manager->getSubListTime($allNodes);		
...
<form name="form3<?php echo $arrparent['leafId'];?>" method="post" action="<?php echo base_url();?>new_task/leaf_edit_Task/<?php echo $arrparent['leafId'];?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>">
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	...
	<tr>
		...
		<td>  <textarea name="edittask<?php echo $arrparent['leafId'];?>" id="edittask<?php echo $arrparent['leafId'];?>" rows="3" cols="35"><?php echo stripslashes($arrparent['contents']);?></textarea></td>	
...
<input type="button" name="Replybutton" value="<?php echo $this->lang->line('txt_Done');?>" onClick="validate_dis('edittask<?php echo $arrparent['leafId'];?>',document.form3<?php echo $arrparent['leafId'];?>);"> &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="Replybutton1" value="Cancel" onClick="edit_close1(<?php echo $arrparent['leafId'];?>, <?php echo $arrparent['nodeId'];?>);">

		        <input name="reply" type="hidden" id="reply" value="1">

				<input name="editorname1" type="hidden"  value="edittask<?php echo $arrparent['leafId'];?>">
				...
				<input type="hidden" name="urlToGo" value="view_task/node_task/<?php echo $arrparent['nodeId'];?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" id="urlToGo">

				<input name="treeId" type="hidden" id="treeId" value="<?php echo $arrparent['treeIds'];?>">

				<input type="hidden" name="taskId" value="<?php echo $arrparent['nodeId'];?>"> 
...
<script>chnage_textarea_to_editor('edittask<?php echo $arrparent['leafId'];?>','simple')</script>
...
<span class="style1">
...

	{
		...
		echo '<a href="'.base_url().'view_task/node_task/'.$checkPre.'/'.$workSpaceId.'/type/'.$workSpaceType.'"><img src="'.base_url().'images/left.gif" alt="Up" vspace="0" border="0" /></a>&nbsp;&nbsp;';
...

	{
		...
		echo '<a href="'.base_url().'view_task/node/'.$arrparent['treeIds'].'/'.$workSpaceId.'/type/'.$workSpaceType.'"><img src="'.base_url().'images/left.gif" alt="Up" vspace="0" border="0" /></a>&nbsp;&nbsp;';
...
echo stripslashes($arrparent['contents']);?>
		...
		<form name="form1" method="post" action="<?php echo base_url();?>new_task/node_new_Task/<?php echo  $arrparent['treeIds'];?>"><table width="100%" border="0" cellspacing="0" cellpadding="5">

<tr><td>

		<span id="vk12345"></span><?php echo $this->lang->line('txt_Task');?>:
...
<tr>
     ...
     <td align="left" colspan="2">
		...
		<a href="javascript:reply(0, <?php echo $arrparent['nodeId'];?>);">Add Task</a>
...
<?php
	...
	{		 //print_r($arrparent);	
			...
			$arrChildNodes = $this->task_db_manager->getChildNodes($arrparent['nodeId'], $arrparent['treeIds']);	
			...
			while($counter < count($sArray)){
				...
				$taskTitle = $this->lang->line('txt_Sub_List_Title');	
	...
	<tr>
		...
		<span id="latestcontent<?php echo $arrDiscussions['leafId'];?>"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			...
			<td id="editcontent<?php echo $position;?>" onClick="showdetail(<?php echo $position;?>,<?php echo $arrDiscussions['nodeId'];?>);" class="handCursor <?php echo ($viewTags[0]['systemTag']==1)?$viewTags[0]['tagName']."_systemTag":"";?>">		
...
<span id="new<?php echo $position;?>" class="style1" style="text-decoration:blink; color:#FF0000;"> <?php //if(!$viewCheck){ echo '<blink>'.$this->lang->line('txt_New').'</blink>';	}?></span> <?php if($checksucc){
	...
	echo '<a href="'.base_url().'view_task/node_task/'.$arrDiscussions['nodeId'].'/'.$workSpaceId.'/type/'.$workSpaceType.'"><img src="'.base_url().'images/right.gif" alt="Up" vspace="0" border="0" /></a>&nbsp;&nbsp;';
...
<form name="form3<?php echo $arrDiscussions['leafId'];?>" method="post" action="<?php echo base_url();?>new_task/leaf_edit_Task/<?php echo $arrDiscussions['leafId'];?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><table width="100%" border="0" cellspacing="0" cellpadding="0">
...

{
	...
	<tr>
	    ...
	    <td  valign="top">&nbsp;<input type="radio" name="calendarStatus" value="Yes" <?php if($arrDiscussions['viewCalendar'] == 1) { echo 'checked'; }?>>
...
<tr>
		...
		<td>
				...
				<input type="button" name="Replybutton" value="<?php echo $this->lang->line('txt_Done');?>" onClick="validate_dis('edittask<?php echo $arrDiscussions['leafId'];?>',document.form3<?php echo $arrDiscussions['leafId'];?>);"> &nbsp;&nbsp;&nbsp;&nbsp;<input type="button" name="Replybutton1" value="Cancel" onClick="edit_close(<?php echo $arrDiscussions['leafId'];?>,<?php echo $arrDiscussions['nodeId'];?>);">
				...
				<input type="hidden" name="urlToGo" value="view_task/node_task/<?php echo $myPid;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>" id="urlToGo">
...
<script>chnage_textarea_to_editor('edittask<?php echo $arrDiscussions['leafId'];?>','simple')</script>
...
<form name="formAdd<?php echo $position;?>" method="post" action="<?php echo base_url();?>new_task/new_task1/<?php echo $arrparent['treeIds'];?>"><table width="100%" border="0" cellspacing="0" cellpadding="5">
...
<textarea name="newTask"></textarea>
...
<td>
	...
	<input type="button" name="Replybutton" value="<?php echo $this->lang->line('txt_Done');?>" onClick="validate_task('replyDiscussion<?php echo $arrDiscussions['nodeId'];?>',document.formAdd<?php echo $position;?>);"> <input type="button" name="Replybutton1" value="Cancel" onClick="addTaskClose(<?php echo $position;?>,<?php echo $arrDiscussions['nodeId'];?>);">
...
?>
	...
	<tr>
		...
		<a href="<?php echo base_url();?>new_task/start_sub_task/<?php echo $arrDiscussions['nodeId'];?>/index/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>"><?php echo $this->lang->line('txt_Add_Sub_Task');?></a>&nbsp;&nbsp;

		<a href="javascript:addTask(<?php echo $position;?>, <?php echo $arrDiscussions['nodeId'];?>);"><?php echo $this->lang->line('txt_Add_Task');?></a>&nbsp;&nbsp;
	...
	//if(in_array($_SESSION['userId'],$arrNodeTaskUsers))
