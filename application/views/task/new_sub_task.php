...
?>
  ...
  <table width="75%" style="margin-left:70px;" border="0" cellspacing="6" cellpadding="1" class="tbl" >
    ...
    <tr>
      ...
      <td valign="top" ><div class="talkform<?php echo $pnodeId;?>"><textarea name="replyDiscussion<?php echo $pnodeId;?>" id="replyDiscussion<?php echo $pnodeId;?>" rows="3" cols="35"></textarea></div></td>
...
<!--	<input type="checkbox" name="endCheck" onClick="calendarEndCheck(this)">
	...
	<tr id="mark_calender<?php echo $pnodeId;?>" style="display:none;">
	    ...
	    <td width="66%" valign="top" style="margin:0px; padding:0px;">&nbsp;<input type="radio" name="calendarStatus" value="Yes">
