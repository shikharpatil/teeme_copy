...
?>
			...
			?>
             ...
             <div class="errorMsg" style="height:40px; margin-top:10px;" >
				   ...
				   ?>
					...
					<tr>
						...
						<td width="85%" align="left" valign="top" class="tdSpace"> 
        					...
        					<input type="checkbox" name="users[]" id="checkAll" onclick="checkAllFunction();" value="0" <?php if ($arrDiscussionDetails['userId']!=$_SESSION['userId']) { echo 'disabled="disabled"';}?>/> <?php echo $this->lang->line('txt_All');?><br />
