<form class="formTask" name="formAddTask<?php echo $position;?>" id="formAddTask<?php echo $position;?>" method="post" >
...
<div class="subTaskMobile"> <img src="<?php echo base_url();?>images/greennew.png" style="margin-right:5px;"  border="none" alt="<?php echo $this->lang->line('txt_Start_Time');?>"   /> <span style="vertical-align:top" ><?php echo $this->lang->line('txt_Start_Time');?>:</span> <!--<input type="checkbox" name="startCheck" id="startCheck" onClick="calStartCheck(this)" style="float:left">--></div>
	...
	<!--Manoj: Added for calendar test-->
	<!--<div>
		<input type="text" data-role="date" class="date-input" onclick="$('.date-input').datetimepicker(); $('.date-input').datetimepicker('show');" readonly> <br />
	</div>-->
	...
	<input type="checkbox" id="startCheck" name="startCheck" onClick="calStartCheck(this, <?php echo $position;?>, document.formAddTask<?php echo $position;?>,'<?php echo $this->time_manager->getUserTimeFromGMTTime($this->time_manager->getGMTtime(),'d-m-Y H:i');?>')">
		...
		<input name="starttime" type="text" data-field="datetime" style="background-color:#CCCCCC;color:#626262;" class="date-input-start" id="starttime<?php echo $this->uri->segment(9);?>" value="<?php echo $this->time_manager->getUserTimeFromGMTTime($this->time_manager->getGMTtime(),'d-m-Y H:i');?>"  readonly>  

<div id="dtBox"></div>	
	<!--Manoj: Added for calendar test end-->	
	
		<!--Manoj: Changed the date format Y-m-d to d-m-y-->
    	<?php /*?><input name="starttime" type="hidden" id="starttime" size="16"  value="<?php echo $this->time_manager->getUserTimeFromGMTTime($this->time_manager->getGMTTime(), 'd-m-Y H:i');?>">
  ...
  <input type="checkbox" id="endCheck" name="endCheck" onClick="calEndCheck(this, <?php echo $position;?>, document.formAddTask<?php echo $position;?>,'<?php echo $this->time_manager->getUserTimeFromGMTTime($this->time_manager->getGMTtime(),'d-m-Y H:i');?>')">
		<!--Manoj: Added readonly -->
		<input name="endtime" type="text" data-field="datetime" style="background-color:#CCCCCC;color:#626262;" id="endtime<?php echo $this->uri->segment(9);?>" class="date-input-end" value="<?php echo $this->time_manager->getUserTimeFromGMTTime($this->time_manager->getGMTtime(),'d-m-Y H:i');?>"  readonly>
...
<!--  <div class="subTaskMobile"> <img src="<?php echo base_url();?>images/greennew.png" style="margin-right:5px;"  border="none" alt="<?php echo $this->lang->line('txt_Start_Time');?>"   /> <span style="vertical-align:top" ><?php echo $this->lang->line('txt_Start_Time');?>:</span>
  ...
  <div id="showMem" class="subTaskMobile" style="display:none;">
   ...
   <!--Manoj: copy code of txt_me from here-->
	<?php	
  ...
  <div id="audioRecordBox"><div style="float:left;margin-top:5px;margin-left:1%"><span id="drop" style="margin-left:0%;"><a title="Record an audio" style="margin-left:0%; cursor:pointer;" onClick="startAudioRecord(3,'<?php echo $nodeId;?>');"><span class="fa fa-microphon"></span></a></span></div><div id="3audio_record<?php echo $nodeId;?>" style="display:none; margin-left:2%; margin-top:0%; float:left;"></div></div>
