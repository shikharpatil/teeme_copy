...
<div class="tab_for_landscape task_tab_for_landscape">
		...
		//Manoj: Code for showing user tag name 
			...
			<tr class="<?php echo $nodeBgColor;?>">				
				...
				<td id="<?php echo $position++;?>" class="handCursor">
					...
					<?php 
						...
						echo '<a href='.base_url().'view_task/node/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/1/'.$treeId.' style="text-decoration:none; color:#000;">'.$this->identity_db_manager->formatContent($arrDiscussionDetails['name'],250,1).'</a>';
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0">
			...
			<tr class="<?php echo $nodeBgColor;?>">				
				...
				<td colspan="3" id="<?php echo $position++;?>" class="handCursor">
					...
					echo '<a href='.base_url().'view_task/node/'.$treeId.'/'.$workSpaceId.'/type/'.$workSpaceType.'/1/'.$arrVal["nodeId"].' style="text-decoration:none; color:#000;">'.$this->identity_db_manager->formatContent($arrVal['contents'],250).'</a>';
