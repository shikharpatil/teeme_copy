	...
	?>
	 ...
	 <div class="row-active-header">
                ...
                <!-- Changed By Surbhi IV-->
		 		...
		 		<div class="row-active-header-inner1" style="width:65%; padding:0;">

					<span class="rowHeaderFont" ><a href="<?php echo base_url();?>view_task/View_All/0/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/0/1"><?php echo $this->lang->line('txt_Task');?></a></span> (<?php echo count($arrDiscussions); ?>)

				</div>

				
				<!--Manoj: comment for created by text-->
				<?php /*?><div class="row-active-header-inner2" style="width:33%;" >
				...
				<!--<div class="row-active-header-inner3"  >
					...
					<span class="rowHeaderFont" ><a href="<?php //echo base_url();?>view_task/View_All/0/<?php //echo $workSpaceId;?>/type/<?php //echo $workSpaceType;?>/0/3"><?php //echo $this->lang->line('txt_Modified_Date');?></a></span>
