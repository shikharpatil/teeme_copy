...
<table width="100%">
          <tr>
            <td colspan="4" align="left" valign="top" class="tdSpace"><ul class="rtabs">
				...
				<li><a href="<?php echo base_url()?>view_activity/node/<?php echo $treeId;?>/<?php echo $workSpaceId;?>/type/<?php echo $workSpaceType;?>/3" class="current"><span><?php echo $this->lang->line('txt_Tag_View');?></span></a></li>
...
if($tagId > 0 || $arrDiscussionDetails['name'] == 'untitled')
{	
