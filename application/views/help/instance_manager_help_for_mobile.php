...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Instance_Manager_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
        <a href="#21">What is the role of Instance Manager?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>What is the role of Instance Manager?</b><br />
<p>The Instance of Teeme is a standalone copy of Teeme installed on server. It can support multiple Places or communities. The administrator of this instance is called Super Instance Manager. The Super Instance manager performs following admin tasks -</p>
<p><ol><li>Create a Place and assign a Place manager. For the specified Place time zone is selected.  A Place can also be deleted or temporarily retired.</li><li>Take a backup of the whole Instance.</li><li>Select features of the editor to be used in the Instance.</li><li>4.	Assign other Instance Managers. Instance Manager can perform all the tasks of Super Instance Manager except assigning other Instance Managers. </li></ol></p>
<p><img src="<?php echo base_url();?>images/help/instance_manager.gif" alt="<?php echo $this->lang->line('txt_Instance_Manager');?>" title="<?php echo $this->lang->line('txt_Instance_Manager');?>" border="0" width="100%"></p>
<a href="#top">Top</a></p>
...
<img src="<?php echo base_url();?>images/help/tree.jpg" alt="<?php echo $this->lang->line('txt_Tree');?>" title="<?php echo $this->lang->line('txt_Tree');?>" border="0" width="100%">
<br />
...
<img src="<?php echo base_url();?>images/help/leaf.jpg" alt="<?php echo $this->lang->line('txt_Leaf');?>" title="<?php echo $this->lang->line('txt_Leaf');?>" border="0" width="100%">
<br />
<a href="#top">Top</a></p>
...
<img src="<?php echo base_url();?>images/help/tree_view.jpg" alt="<?php echo $this->lang->line('txt_Tree');?>" title="<?php echo $this->lang->line('txt_Tree');?>" border="0" width="100%">
<br />
...
<br />
<img src="<?php echo base_url();?>images/help/originator.gif" alt="<?php echo $this->lang->line('txt_Originator');?>" title="<?php echo $this->lang->line('txt_Originator');?>" border="0" width="100%">
<br />
...
<p><img src="<?php echo base_url();?>images/help/tag_view.gif" alt="<?php echo $this->lang->line('txt_Tag_View');?>" title="<?php echo $this->lang->line('txt_Tag_View');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/link_view.gif" alt="<?php echo $this->lang->line('txt_Link_View');?>" title="<?php echo $this->lang->line('txt_Link_View');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/time_view.gif" alt="<?php echo $this->lang->line('txt_Time_View');?>" title="<?php echo $this->lang->line('txt_Time_View');?>" border="0" width="100%"></p>
...
<img src="<?php echo base_url();?>images/help/simple_tags_01.gif" alt="<?php echo $this->lang->line('txt_Simple_Tags');?>" title="<?php echo $this->lang->line('txt_Simple_Tags');?>" border="0" width="100%">
<br />
Clicking on an idea/leaf shows the menu items containing Tags. Step 1 – click on menu Tags. 
<br />
<img src="<?php echo base_url();?>images/help/simple_tags_02.gif" alt="<?php echo $this->lang->line('txt_Simple_Tags');?>" title="<?php echo $this->lang->line('txt_Simple_Tags');?>" border="0" width="100%">
<br />
...
<p><img src="<?php echo base_url();?>images/help/response_tags01.gif" alt="<?php echo $this->lang->line('txt_Response_Tags');?>" title="<?php echo $this->lang->line('txt_Response_Tags');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/response_tags02.gif" alt="<?php echo $this->lang->line('txt_Response_Tags');?>" title="<?php echo $this->lang->line('txt_Response_Tags');?>" border="0" width="100%"></p>
<a href="#top">Top</a></p>
...
<p><br><br><img src="<?php echo base_url();?>images/help/linking04.gif" alt="<?php echo $this->lang->line('txt_Linking');?>" title="<?php echo $this->lang->line('txt_Linking');?>" border="0" width="100%"></p>
<a href="#top">Top</a></p>
...
<p><img src="<?php echo base_url();?>images/help/talk01.gif" alt="<?php echo $this->lang->line('txt_Talk');?>" title="<?php echo $this->lang->line('txt_Talk');?>" border="0" width="100%"></p>
<p>This will open the Talk tool in a separate window. </p>
<p><img src="<?php echo base_url();?>images/help/talk02.gif" alt="<?php echo $this->lang->line('txt_Talk');?>" title="<?php echo $this->lang->line('txt_Talk');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/talk03.gif" alt="<?php echo $this->lang->line('txt_Talk');?>" title="<?php echo $this->lang->line('txt_Talk');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/talk04.gif" alt="<?php echo $this->lang->line('txt_Talk');?>" title="<?php echo $this->lang->line('txt_Talk');?>" border="0" width="100%"></p>
<a href="#top">Top</a></p>
...
<p><img src="<?php echo base_url();?>images/help/sharing01.gif" alt="<?php echo $this->lang->line('txt_Sharing');?>" title="<?php echo $this->lang->line('txt_Sharing');?>" border="0" width="100%"></p>
<p>The Share tab in only available in the trees created in My Space. Using this tab we can share the tree with others. </p>
<p><img src="<?php echo base_url();?>images/help/sharing02.gif" alt="<?php echo $this->lang->line('txt_Sharing');?>" title="<?php echo $this->lang->line('txt_Sharing');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/sharing03.gif" alt="<?php echo $this->lang->line('txt_Sharing');?>" title="<?php echo $this->lang->line('txt_Sharing');?>" border="0" width="100%"></p>
...
<p>The editor provided with Teeme let users edit text. Teeme provides full editor as well as small editor. The following screen shows the editor and its features available through the icons. For editing larger content you can toggle the editor to full screen mode by using the last icon in second row - <img src="<?php echo base_url();?>images/help/editor01.gif" alt="<?php echo $this->lang->line('txt_Editor');?>" title="<?php echo $this->lang->line('txt_Editor');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/editor02.gif" alt="<?php echo $this->lang->line('txt_Editor');?>" title="<?php echo $this->lang->line('txt_Editor');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/editor03.gif" alt="<?php echo $this->lang->line('txt_Editor');?>" title="<?php echo $this->lang->line('txt_Editor');?>" border="0" width="100%"></p>
...
<p><img src="<?php echo base_url();?>images/help/photos01.gif" alt="<?php echo $this->lang->line('txt_Photos_Images');?>" title="<?php echo $this->lang->line('txt_Photos_Images');?>" border="0" width="100%"></p>
<p><img src="<?php echo base_url();?>images/help/photos02.gif" alt="<?php echo $this->lang->line('txt_Photos_Images');?>" title="<?php echo $this->lang->line('txt_Photos_Images');?>" border="0" width="100%"></p>
<p>Paste the url in the Image url filed and click Insert.</p>
<p><img src="<?php echo base_url();?>images/help/photos03.gif" alt="<?php echo $this->lang->line('txt_Photos_Images');?>" title="<?php echo $this->lang->line('txt_Photos_Images');?>" border="0" width="100%"></p>
