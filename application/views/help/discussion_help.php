...
<title><?php echo $this->lang->line('txt_Discussion_Help');?></title>
...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Discussion_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
		<a href="#21">How to use Discussion tree?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>How to use Discussion tree? </b><br />
<p>The Discussion trees are meant for capturing and facilitating longer conversations among team members. The tree is threaded so we can have multiple related topics and their replies. As Discussion tree captures conversations – the Talk tool is not available in either seed or leaves. Tagging and Linking is provided. </p><p>The screen below shows a Discussion tree. </p>
<p><img src="<?php echo base_url();?>images/help/discussion0001.JPG" alt="<?php echo $this->lang->line('txt_Discussion_Tree');?>" title="<?php echo $this->lang->line('txt_Discussion_Tree');?>" border="0"></p>
<p>The Discussion view shows the number of topics currently available for the discussion.  A new topic can be submitted using the editor. A reply to the topic can be made from the menu items.</p>
<p><img src="<?php echo base_url();?>images/help/discussion0002.JPG" alt="<?php echo $this->lang->line('txt_Discussion_Tree');?>" title="<?php echo $this->lang->line('txt_Discussion_Tree');?>" border="0"></p>
<p>
A topic which contains replies has an arrow on top. Clicking on the arrow takes us to the reply page for the topic.
</p>
<p><img src="<?php echo base_url();?>images/help/discussion0003.JPG" alt="<?php echo $this->lang->line('txt_Discussion_Tree');?>" title="<?php echo $this->lang->line('txt_Discussion_Tree');?>" border="0"></p>
<p>This page shows the reply for the topic shown on top. New replies can be added using the editor.  Both topics and replies are shown in chronological order capturing the natural progression of the discussion as it occurs. </p>
<p>The Time View, Tag View and Link View function as described separately.</p>
...
<p><img src="<?php echo base_url();?>images/help/talk0001.jpg" alt="<?php echo $this->lang->line('txt_Talk');?>" title="<?php echo $this->lang->line('txt_Talk');?>" border="0"></p>
<p>This will open the Talk tool. </p>
<p><img src="<?php echo base_url();?>images/help/talk0002.jpg" alt="<?php echo $this->lang->line('txt_Talk');?>" title="<?php echo $this->lang->line('txt_Talk');?>" border="0"></p>
<p>The Talk tool shows partial contents from the leaf it is associated with. This helps in maintaining the context for the Talk. The Talk tool can be closed by (1) close button or (2) clicking mouse outside the tool.  As multiple users can use the tool simultaneously – clicking on Update icon refreshes the Talk with latest comments.</p>
<p>A user can leave comment using the editor. The following screen shows the Talk tool with few comments – </p>
<p><img src="<?php echo base_url();?>images/help/talk0003.jpg" alt="<?php echo $this->lang->line('txt_Talk');?>" title="<?php echo $this->lang->line('txt_Talk');?>" border="0"></p>
