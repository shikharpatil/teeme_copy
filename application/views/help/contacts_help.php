...
<title><?php echo $this->lang->line('txt_Contacts_Help');?></title>
...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Contacts_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
		<a href="#21">How to use Contact tree?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>How to use Contact tree? </b><br />
<p>A contact tree is used for keeping information about a client, customer, contact or prospect. These persons are not part of the internal project team but are external stakeholders or decision makers. Any time somebody form within the project interacts with the client he can share this information within team by updating the contact tree. </p>
<p>In the contact tree only the member contributing the note can re-edit the content as she is the only one who interacted with the client. Others can participate using tagging, linking and talk.</p>
<p>A client or prospect may be relevant only to a project or multiple projects within a company. Teeme provides ways to define a contact as a private contact for a project (space) or public within the place so that other projects can also use the client. </p>
<p>A contact created in Teeme is also available for tagging using Contact tag. This way we can categorize specific content with contact(s).</p>
<p>This screen below shows how a contact can be created –</p>
<p><img src="<?php echo base_url();?>images/help/contact01.gif" alt="<?php echo $this->lang->line('txt_Contacts_Tree');?>" title="<?php echo $this->lang->line('txt_Contacts_Tree');?>" border="0"></p>
<p>The other information required to finish creating a contact is as follow. </p>
<p><img src="<?php echo base_url();?>images/help/contact02.gif" alt="<?php echo $this->lang->line('txt_Contacts_Tree');?>" title="<?php echo $this->lang->line('txt_Contacts_Tree');?>" border="0"></p>
<p>Additional contact information is required about the contact. Status is important update on contact which is shared among the team. Any member can change the status anytime. Other details field captures any other detail required to be shared. </p>
<p>The created contact tree is shown below. </p>
<p><img src="<?php echo base_url();?>images/help/contact03.gif" alt="<?php echo $this->lang->line('txt_Contacts_Tree');?>" title="<?php echo $this->lang->line('txt_Contacts_Tree');?>" border="0"></p>
<p>A note can only be entered from seed thus showing the latest note on top. The full details are shown below –</p>
<p><img src="<?php echo base_url();?>images/help/contact04.gif" alt="<?php echo $this->lang->line('txt_Contacts_Tree');?>" title="<?php echo $this->lang->line('txt_Contacts_Tree');?>" border="0"></p>
<p>By clicking edit button the details can be changed. </p>
<p>A note or seed both have Tag, Links and Talk tool for further team interactions. Time View, Tag View and Link View are provided. </p>
<a href="#top">Top</a></p>
