...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Import_Files_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
		<a href="#21">What are imported files?</a><br />
        <a href="#22">How to import a file?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>What are imported files?</b><br />
<p>Any external files can be imported into a Space. This way it can be shared among the members of the Space. This imported file can be linked to a seed or leaf of a tree through Links tool as well.</p>
<a href="#top">Top</a></p>


<a name="22"></a>
<p><b>How to import a file?</b><br />
<p>The Import File menu item is located at the bottom part of the desk top. Selecting it results in the following screen –</p>
<p><img src="<?php echo base_url();?>images/help/import01.gif" alt="<?php echo $this->lang->line('txt_Import_File');?>" title="<?php echo $this->lang->line('txt_Import_File');?>" border="0"></p>
<p>If you caption the file with an existing name Teeme appends appropriate version information. This way you can import files which are going through changes and Teeme will do internal version control. Clicking on Url field will select the physical url of the file which can be copied and used when needed.</p>
<p>Imported File tab shows the files which have been imported in the Acme Space. Search field let you filter the file names. To import a file click on the Import File tab and follow these steps –</p>
<p><img src="<?php echo base_url();?>images/help/import02.gif" alt="<?php echo $this->lang->line('txt_Import_File');?>" title="<?php echo $this->lang->line('txt_Import_File');?>" border="0"></p>
<p><ol><li>Select the file from the local or network computer using Browse button.</li><li>Caption the selected file.</li><li>Press Done.</li></ol></p>
<a href="#top">Top</a></p>
