...
<title><?php echo $this->lang->line('txt_Task_Help');?></title>
...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Task_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
		<a href="#21">How to use Task tree?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>How to use Task tree? </b><br />
<p>The task trees help in managing tasks for the project. A task tree – contains tasks and task lists. A task list consists of related sub-tasks. </p>
<p>A task or sub-task has an originator and a person who is responsible for the task. A task can have –<ul><li>No start and end time specified. It is open ended task. </li><li>Only start time specified meaning it must commence on specified time. </li><li>Only end time specified meaning it must finish by specified time.</li><li>Both start and end time specified meaning it has fixed period. </li></ul></p>
<p>If a task has any aspect of time specified then user has an option to mark the task on calendar. Marking on calendar makes a task visible on calendar – only key milestones and events should be marked on calendar. </p>
<p>The following screen shows how a task tree is created. A task is also specified and marked to calendar. </p>
<p><img src="<?php echo base_url();?>images/help/task01.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>The calendar tool should be used as shown below. To close the tool the selected date should be clicked by user. The time selection can be made prior to this. </p>
<p><img src="<?php echo base_url();?>images/help/task02.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>The screen below shows the created tree.</p>
<p><img src="<?php echo base_url();?>images/help/task03.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>Let us add task to the tree by clicking Add Task menu item. </p>
<p><img src="<?php echo base_url();?>images/help/task04.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>This will add the Select Project supplier task to the tree. Sub-tasks can be added to this task. And because sub-tasks are added this task will become a task list. </p>
<p><img src="<?php echo base_url();?>images/help/task05.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>We can open this task list to view sub tasks. Sub tasks have the same properties as tasks.</p>
<p><img src="<?php echo base_url();?>images/help/task06.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>A task can be edited later to either share more information such as completion status or changes in start and end times or person(s) assigned to perform the task. </p>
<p><img src="<?php echo base_url();?>images/help/task07.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>The completion status change results in the information being visually shown in the status rectangle. </p>
<p><img src="<?php echo base_url();?>images/help/task08.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>The task tree provides two additional views – Calendar View and Task search. The following screen shows the Calendar view of the task tree-</p>
<p><img src="<?php echo base_url();?>images/help/task09.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>This view opens in the current month and the current date is highlighted. You can scroll the months to generate view of any specific month. The marked to calendar tasks are shown. The start time is denoted by green dot and the end time is denoted by red dot. You can also click on the tasks which are hyperlinked and will take to the Task view and highlight the task. </p>
<p>If we select any specific date the calendar shows the Day view. </p>
<p><img src="<?php echo base_url();?>images/help/task10.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>We can also generate week view by clicking on Week view tab. </p>
<p><img src="<?php echo base_url();?>images/help/task11.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>The day and week view scroll within the current month. </p>
<p>The Task Search tab provides advanced search facility for task trees. </p>
<p><img src="<?php echo base_url();?>images/help/task12.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p>The first tree tabs show predefined filters for viewing tasks –<ol><li>Tasks which are overdue.</li><li>Tasks which are due Today.</li><li>Tasks due in next 7 days.</li></ol></p>
<p>The fourth tab provides a flexible searching tool.</p>
<p><img src="<?php echo base_url();?>images/help/task13.gif" alt="<?php echo $this->lang->line('txt_Task_Tree');?>" title="<?php echo $this->lang->line('txt_Task_Tree');?>" border="0"></p>
<p> The tool let you decide the team members for filter – both who specified the tasks (By field) and who is responsible for the task (Assigned to field). You may specify date filters. If date filters are specified you can sort the results based on dates or alphabetically. Clicking Go button shows the tasks meeting the filter criteria. By clicking on the task you can highlight the task in the Task view. </p>
<p>If none of the date filter is specified the tasks with no date attributes are selected. </p>
<a href="#top">Top</a></p>
...
<img src="<?php echo base_url();?>images/help/simple_tags_01.gif" alt="<?php echo $this->lang->line('txt_Simple_Tags');?>" title="<?php echo $this->lang->line('txt_Simple_Tags');?>" border="0">
<br />
Clicking on an idea/leaf shows the menu items containing Tags. Step 1 – click on menu Tags. 
<br />
<img src="<?php echo base_url();?>images/help/simple_tags_02.gif" alt="<?php echo $this->lang->line('txt_Simple_Tags');?>" title="<?php echo $this->lang->line('txt_Simple_Tags');?>" border="0">
<br />
