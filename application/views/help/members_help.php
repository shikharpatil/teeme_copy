...
<title><?php echo $this->lang->line('txt_Members_Help');?></title>
...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Members_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
		<a href="#21">How to use Members?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>How to use Members? </b><br />
<p>Members menu shows us the members of the team in the current space. Each user has a profile which is partly created at the time the user is defined in the Place by Place Manager. Then user can further define the profile attributes. From My Space – members menu shows all the members in the Place. </p>
<p>The member profiles are used for –<ol><li>Communicating from user current status and other useful information.</li><li>Other users can leave private or public message on a user profile.</li></ol></p>
<p>The members are not trees they merely help in exchanging one-to-one information among members. The following screen shows the members from a space. </p>
<p><img src="<?php echo base_url();?>images/help/members01.gif" alt="<?php echo $this->lang->line('txt_Members');?>" title="<?php echo $this->lang->line('txt_Members');?>" border="0"></p>
<p>We can see the status and login information from this page. Clicking on the user tag will open the profile page for the user. Comments can be entered using this page. </p>
<p><img src="<?php echo base_url();?>images/help/members02.gif" alt="<?php echo $this->lang->line('txt_Members');?>" title="<?php echo $this->lang->line('txt_Members');?>" border="0"></p>
<p>The private comments are shown only to the target user and the authoring user. </p>
<p><img src="<?php echo base_url();?>images/help/members03.gif" alt="<?php echo $this->lang->line('txt_Members');?>" title="<?php echo $this->lang->line('txt_Members');?>" border="0"></p>
<p>Only the user can edit the status updates on his profile. Both recipient user and authoring user can delete the comment whether private or public. </p>
<p>The following screen show how Ken sees Paul’s profile. Note that the private comment from John is missing.</p>
<p><img src="<?php echo base_url();?>images/help/members04.gif" alt="<?php echo $this->lang->line('txt_Members');?>" title="<?php echo $this->lang->line('txt_Members');?>" border="0"></p>
<p>In this example Paul can edit his profile details using Edit Profile menu in the seed. </p>
<p><img src="<?php echo base_url();?>images/help/members05.gif" alt="<?php echo $this->lang->line('txt_Members');?>" title="<?php echo $this->lang->line('txt_Members');?>" border="0"></p>
<a href="#top">Top</a></p>
