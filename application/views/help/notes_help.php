...
<title><?php echo $this->lang->line('txt_Notes_Help');?></title>
...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Notes_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
		<a href="#21">How to use Notes tree?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>How to use Notes tree? </b><br />
<p>A Notes tree can be used for capturing factual information about a particular event by team members. For example two of the team members John Hill and Paul Green attended the client with Acme. They use Notes tree to collaborate between them (as only these two were present in the meeting) to capture the minutes of the meeting for the rest of the team. </p>
<p>Paul creates a Notes tree specifying the title as well as contributors who can edit the contents of the tree – in this case John and himself. The following screen shows this.</p>
<p><img src="<?php echo base_url();?>images/help/notes01.gif" alt="<?php echo $this->lang->line('txt_Notes_Tree');?>" title="<?php echo $this->lang->line('txt_Notes_Tree');?>" border="0"></p>
<p>A notes tree is created and notes can be submitted and edited by John and Paul. </p>
<p><img src="<?php echo base_url();?>images/help/notes02.gif" alt="<?php echo $this->lang->line('txt_Notes_Tree');?>" title="<?php echo $this->lang->line('txt_Notes_Tree');?>" border="0"></p>
<p>A note can be added from seed or any note leaf by contributors. Only originator of the tree can nominate contributors. The following screen shows how this tree is shown to Mary who is not a contributor. </p>
<p><img src="<?php echo base_url();?>images/help/notes03.gif" alt="<?php echo $this->lang->line('txt_Notes_Tree');?>" title="<?php echo $this->lang->line('txt_Notes_Tree');?>" border="0"></p>
<p>She can not contribute notes to the tree but she can do tagging and linking as well initiate talks.  This way the whole team can interact, participate and converse about the meeting. </p>
<p>The Time View, Tag View and Link Views are also available for the tree. </p>
<a href="#top">Top</a></p>
