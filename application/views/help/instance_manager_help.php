...
<p><img src="<?php echo base_url();?>images/help/instance_manager.gif" alt="<?php echo $this->lang->line('txt_Instance_Manager');?>" title="<?php echo $this->lang->line('txt_Instance_Manager');?>" border="0"></p>
<a href="#top">Top</a></p>
