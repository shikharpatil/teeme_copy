...
<title><?php echo $this->lang->line('txt_Chat_Help');?></title>
...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Chat_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
		<a href="#21">How to use Chat tree?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>How to use Chat tree? </b><br />
<p>Chat tree is designed to capture both asynchronous and synchronous conversations. This tree is similar to instant messenger but also provides additional features –<ul><li>The chat can be multi-threaded. This means in a chat we can have multiple topics and their replies. These replies are collected along with topics so that logical links can be maintained.</li>
<li>A chat can be done over many sessions. This enables a chat to remain opened for any desired length of time and users can come at different time and participate with chat. The chat can operate both synchronously as well as asynchronously.</li>
<li>A chat can be stopped and started many times. </li>
<li>Chat tree has Real time View where it facilitates synchronous conversations.</li>
<li>It also has a logical view where it maintains logical connections with topics and replies. The users can also use this view to participate in Chat sessions.  </li>
<li>During and after the chat sessions users can use Tagging and Linking features to continue participation with the content of the chat. Even after the chat has been stopped. </li>
</ul></p>
<p>Only originator of the chat tree can stop the chat. Any user can re-start a stopped chat whenever needed. This is analogous to having series of telephone conferences and keeping record of these sessions.</p>
<p>View menu shows all the chat trees. The active chats have green dot next to them while chats which have been stopped have red dot next to them. </p>
<p>Selecting Create menu shows the following screen to start a Chat tree –</p>
<p><img src="<?php echo base_url();?>images/help/chat01.gif" alt="<?php echo $this->lang->line('txt_Chat_Tree');?>" title="<?php echo $this->lang->line('txt_Chat_Tree');?>" border="0"></p>
<p>This creates the Chat tree. </p>
<p><img src="<?php echo base_url();?>images/help/chat02.gif" alt="<?php echo $this->lang->line('txt_Chat_Tree');?>" title="<?php echo $this->lang->line('txt_Chat_Tree');?>" border="0"></p>
<p>This active Chat tree has a Real time View for instant conversations which are captured based on time.</p>
<p>In Chat view new topics can be initiated from the seed menu only. A topic can have replies. This is shown in the following screen.  </p>
<p><img src="<?php echo base_url();?>images/help/chat03.gif" alt="<?php echo $this->lang->line('txt_Chat_Tree');?>" title="<?php echo $this->lang->line('txt_Chat_Tree');?>" border="0"></p>
<p>The Real time View provides the following screen –</p>
<p><img src="<?php echo base_url();?>images/help/chat04.gif" alt="<?php echo $this->lang->line('txt_Chat_Tree');?>" title="<?php echo $this->lang->line('txt_Chat_Tree');?>" border="0"></p>
<p>The topics and replies are displayed in chronologic order. The topics are shown in light blue while the replies are in dark blue color. Each reply also identifies the topic it is associated with. This maintains the logic links.  The topics and replies are entered through the following user interface –</p>
<p><img src="<?php echo base_url();?>images/help/chat05.gif" alt="<?php echo $this->lang->line('txt_Chat_Tree');?>" title="<?php echo $this->lang->line('txt_Chat_Tree');?>" border="0"></p>
<p>The interface is used for entering both topics and replies. To reply to a topic – <ul><li>Step 1 – Select the topic or a reply to the topic. The selected topic is shown in the Reply To field.  </li><li>Step 2 – enter the reply and then press Done button.</li></ul></p>
<p>To enter a new topic – press the Cancel button to clear the fields and then enter a topic and press Done button.  The screen below shows this.</p>
<p><img src="<?php echo base_url();?>images/help/chat06.gif" alt="<?php echo $this->lang->line('txt_Chat_Tree');?>" title="<?php echo $this->lang->line('txt_Chat_Tree');?>" border="0"></p>
<p>After a chat has been stopped by the originator the following changes occur – <ul><li>Real time view changes to Time View. </li><li>No new topics and replies can be entered. Only Tagging and Linking are allowed. </li><li>The chat can be re-started.</li></ul></p>
<p><img src="<?php echo base_url();?>images/help/chat07.gif" alt="<?php echo $this->lang->line('txt_Chat_Tree');?>" title="<?php echo $this->lang->line('txt_Chat_Tree');?>" border="0"></p>
<a href="#top">Top</a></p>
