...
<tr>
	<td width="100%" colspan="2" valign="top">
    	<div class="heading-home"><?php echo $this->lang->line('txt_Space_Manager_Help');?></div>
    </td>
</tr>
<tr>
	<td width="100%" colspan="2" valign="top">
        <a href="#21">What is the role of Space Manager?</a><br /><br />
    </td>
</tr>
<tr>
    <td width="100%" colspan="2" valign="top">
...
<a name="21"></a>
<p><b>What is the role of Space Manager?</b><br />
<p>A Space is like a project team or department within Place (company). A Space Manager is assigned by Place Manager for the Space. A Space manager is a registered member. Space manager can select the members for the Space and thus control who has access to the Space. </p>
<img src="<?php echo base_url();?>images/help/space_manager_01.gif" alt="<?php echo $this->lang->line('txt_Workspace_Manager');?>" title="<?php echo $this->lang->line('txt_Workspace_Manager');?>" border="0">
<p>The following screen shows the results of selecting Manage Space menu item.  As a Place can have a large number of members – a filter is provided to sort the list based on the filter. The filter is available for both selection of Space managers and members. There can be more than one Space manager. The members selected are shown as checked boxes and are shown on top of the list. </p>
<img src="<?php echo base_url();?>images/help/space_manager_02.gif" alt="<?php echo $this->lang->line('txt_Workspace_Manager');?>" title="<?php echo $this->lang->line('txt_Workspace_Manager');?>" border="0">
<p>A Space manager can also create a sub-space for the Space. He can also select members for the sub-space. The members of the sub-space do not have access to Space and vice versa. If some members need access to both then they need to be member of both the space and sub-space. Using sub-space concept we manage security and access control to the information contained in the Spaces. For example Acme is bidding for a new project to customer X. This project will involve sales team, technical team, marketing team and business administration team from Acme. Also they will invite their external partners to join in the bid. This is a common situation – the technical members of the internal and external team will need common access while business administration will need a sub-space to collaborate on legal and financial issues. </p>
<img src="<?php echo base_url();?>images/help/space_manager_03.gif" alt="<?php echo $this->lang->line('txt_Workspace_Manager');?>" title="<?php echo $this->lang->line('txt_Workspace_Manager');?>" border="0">
<p>Spaces are grayed out if a user do not have access them. </p>
<a href="#top">Top</a></p>
