...
<?php $this->load->view('common/view_head.php');?>
				...
				?>
				<form>
				 <div id="postShare<?php echo $nodeId; ?>" class="postShareBox">
				 <?php
					if($workSpaceId=='0' && $_SESSION['public'] != 'public' && $_SESSION['all'] != 'all' && $this->uri->segment(8)!='bookmark')
					{
						...
						<div class="postSharedMsg" style="color:#099731; margin-left:0px; margin-top:5px;"></div>
						
						<?php
				 		echo $this->lang->line('txt_Select_Group')." : <br><br>"; 
						echo $this->lang->line('txt_Search')." : "; 
						?>
						<input type="text" id="searchEditGroup<?php echo $nodeId; ?>" name="searchEditGroup" onKeyUp="searchEditGroups('<?php echo $nodeId; ?>','<?php echo $originatorUserId; ?>','<?php echo $_SESSION['userId']; ?>')" />
						
						<div id="showManGroup<?php echo $nodeId; ?>" style="height:150px;margin-left:50px; overflow:scroll; margin-bottom:30px; margin-top:20px; width:65%; ">
...
<?php echo $groupData['groupName'];?><br />
					...
					<?php } ?>							
						...
						echo $this->lang->line('txt_Search')." : "; 
						?>
						<input type="text" id="searchTags<?php echo $nodeId; ?>" name="searchTags" onKeyUp="showMySpaceTags('<?php echo $nodeId; ?>','<?php echo $originatorUserId; ?>','<?php echo $_SESSION['userId']; ?>')" />
						
						<?php /*?><div class="postSharedMsg" style="color:#099731; margin-left:58px; margin-top:5px;"></div><?php */?>
						
						<div id="showMan<?php echo $nodeId; ?>" style="height:150px;margin-left:50px; overflow:scroll; margin-bottom:10px; margin-top:10px; width:65%;">
...
<?php
				...
				?>
					...
					?>
					<div>
		  			 <input type="button" name="Replybutton" value="<?php echo $this->lang->line('txt_Ok');?>" onclick="addPostShareUsers('<?php echo $nodeId; ?>')" style="margin-left:50px; float:left;">
					...
					<div style="margin-left:50px;" class="postLoader"></div>
					</div>
					<!--select user list end-->
					<div style="float:left; width:60%; margin-top:4%;">
