<?php /*Copyright © 2008-2014. Team Beyond Borders Pty Ltd. All rights reserved.*/  ?><?php
	...
	************************************************************************************************************
	* Filename				: delete_sub_workspace.php
	* Description 		  	: A class file used to delete the sub work space details
...
class Delete_sub_workspace extends CI_Controller 
{
	...
	{		
		...
		{	
			...
			$this->load->model('dal/identity_db_manager');			
			$this->identity_db_manager->deleteWorkSpaceByWorkspaceId($subWorkSpaceId, 2);
			$_SESSION['errorMsg']	= 	$this->lang->line('sub_workspace_deleted_successfully');								
			redirect('view_sub_work_spaces/index/'.$workSpaceId.'/1','location');			
		}		
	}
