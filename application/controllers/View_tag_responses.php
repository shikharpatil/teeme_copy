<?php /*Copyright © 2008-2014. Team Beyond Borders Pty Ltd. All rights reserved.*/
	...
	************************************************************************************************************
	* Filename				: view_tag_responses.php
	* Description 		  	: A class file used to show the tag responses
...
class View_tag_responses extends CI_Controller 
{
	...
	{		
		...
		{	
			...
			$objIdentity	= $this->identity_db_manager;					
			$arrDetails['artifactId']			= $this->uri->segment(3);
			$arrDetails['artifactType']			= $this->uri->segment(4);			
			$arrDetails['userTags']				= $this->tag_db_manager->getUserTagsByArtifactId($arrDetails['artifactId'],$arrDetails['artifactType']);	
			$arrDetails['sequenceTags']			= $this->tag_db_manager->getSequenceTagsByArtifactId($arrDetails['artifactId'],$arrDetails['artifactType']);
			//view does not exist in folder - Monika	
			$this->load->view('common/view_tag_responses', $arrDetails);						
		}		
	}
