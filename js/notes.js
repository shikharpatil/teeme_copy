...
{	 
	...
	if(document.getElementById('replyDiscussion<?php echo $position;?>1').value=='<DIV id=1-span><P>&nbsp;</P></DIV>')

	{

		jAlert('Please enter the notes','Alert');
...
function addNote1(replyDiscussion,formname)

{

	var replyDiscussion1=replyDiscussion+'1';
...
// This is a js function used to change the periodic

function changePeriodic(curVal)

{
	...
	{	
		...
		document.getElementById('notePeriodic').style.display = '';
...

	{
		...
		document.getElementById('notePeriodic').style.display = 'none';
