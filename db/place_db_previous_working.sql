...
CREATE TABLE `teeme_container_types` (
  `id` int(11) NOT NULL,
  `name` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `teeme_container_types` (`id`, `name`) VALUES
(1, 'Document'),
(2, 'Discussion'),
(3, 'Chat'),
(4, 'Activity'),
...
CREATE TABLE `teeme_countries` (
  `countryId` int(11) NOT NULL,
  `countryName` varchar(64) COLLATE utf8_unicode_ci NOT NULL,
  `countryCode` char(3) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `teeme_periodic_notes` (
  `notesId` int(11) NOT NULL,
  `periodicNotesId` int(11) NOT NULL DEFAULT '0',
...
CREATE TABLE `teeme_sequence_tag` (
  `sequenceId` int(255) NOT NULL,
  `userId` int(11) NOT NULL,
  `createdDate` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `teeme_usergroups` (
  `id` int(11) NOT NULL,
  `placeId` int(11) NOT NULL,
  `placemanagerId` int(11) NOT NULL,
  `createdDate` datetime NOT NULL,
  `lastEditedDate` datetime NOT NULL,
  `lastPlaceManagerId` int(11) NOT NULL,
  `groupName` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE `teeme_usergroups_as_user` (
...
CREATE TABLE `teeme_user_communities` (
  `communityId` tinyint(2) NOT NULL,
  `communityName` varchar(100) COLLATE utf8_unicode_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `teeme_wall` (
  `id` int(11) NOT NULL,
  `owner_id` int(11) NOT NULL,
  `commenter_id` int(11) NOT NULL,
  `comment` longtext COLLATE utf8_unicode_ci NOT NULL,
  `comment_time` datetime NOT NULL,
  `limitation` varchar(64) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'public',
  `status` tinyint(4) NOT NULL DEFAULT '1' COMMENT '1: Active 0:Inactive',
  `urgent` tinyint(4) NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

CREATE TABLE `teeme_wall_comments` (
  `id` int(11) NOT NULL,
  `commenterId` int(11) NOT NULL,
  `commentWorkSpaceId` int(11) NOT NULL DEFAULT '0',
  `commentWorkSpaceType` int(11) NOT NULL DEFAULT '1',
  `comment` longtext CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `commentTime` datetime NOT NULL,
  `limitation` varchar(64) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL,
  `status` tinyint(1) NOT NULL DEFAULT '1' COMMENT '1:active,deactive',
  `parentCommentId` int(11) NOT NULL DEFAULT '0' COMMENT '0 : no parent comment',
  `latestUpdateTime` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `teeme_wall_recipients` (
  `id` int(11) NOT NULL,
  `commentId` int(11) NOT NULL,
  `recipientId` int(11) NOT NULL COMMENT 'message receiver user Id',
  `urgent` tinyint(1) NOT NULL DEFAULT '0',
  `notification` int(1) NOT NULL DEFAULT '1' COMMENT '1:show notification',
  `recipientStatus` int(1) NOT NULL DEFAULT '1' COMMENT '1:active,0:deactive'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

CREATE TABLE `teeme_work_place_managers` (
  `id` int(11) NOT NULL,
  `placeId` int(11) NOT NULL,
  `managerFname` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `managerLname` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `managerAddress` varchar(512) COLLATE utf8_unicode_ci NOT NULL,
  `managerPhone` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `managerMobile` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `managerFax` varchar(20) COLLATE utf8_unicode_ci NOT NULL,
  `managerOther` mediumtext COLLATE utf8_unicode_ci NOT NULL,
  `managerEmail` varchar(150) COLLATE utf8_unicode_ci NOT NULL,
  `managerPassword` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `managerCommunityId` tinyint(4) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
ALTER TABLE `teeme_applied_url`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_backups`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_bookmark`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_chat_info`
  ADD PRIMARY KEY (`treeid`);

ALTER TABLE `teeme_configuration`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_contact_info`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_container_types`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_countries`
  ADD PRIMARY KEY (`countryId`),
  ADD KEY `IDX_COUNTRIES_NAME` (`countryName`);

ALTER TABLE `teeme_create_tag_date`
  ADD PRIMARY KEY (`tagId`);

ALTER TABLE `teeme_discussion_view`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_external_docs`
  ADD PRIMARY KEY (`docId`);

ALTER TABLE `teeme_folders`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_group_shared`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_language_config`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_leaf`
  ADD PRIMARY KEY (`id`);
ALTER TABLE `teeme_leaf` ADD FULLTEXT KEY `contents` (`contents`);

ALTER TABLE `teeme_leaf_objects`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_leaf_reservation`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_leaf_tree`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `teeme_sequence_tag`
...
ALTER TABLE `teeme_user_communities`
...
ALTER TABLE `teeme_wall`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_wall_comments`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_wall_recipients`
  ADD PRIMARY KEY (`id`);

ALTER TABLE `teeme_work_place_managers`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `teeme_sequence_tag`
  MODIFY `sequenceId` int(255) NOT NULL AUTO_INCREMENT;
ALTER TABLE `teeme_sub_work_place`
...
ALTER TABLE `teeme_user_communities`
  MODIFY `communityId` tinyint(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
ALTER TABLE `teeme_user_configuration`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
ALTER TABLE `teeme_vote_tag`
...
INSERT INTO `teeme_templates` (`id`, `template`) VALUES (NULL, 'txt_folder_deleted_by');
INSERT INTO `teeme_notification_template` (`id`, `object_id`, `action_id`, `template_id`, `template_type_id`) VALUES (NULL, '17', '3', '76', '3'), (NULL, '17', '3', '76', '4');
ALTER TABLE `teeme_external_docs` ADD `orig_modified_date` DATETIME NOT NULL AFTER `createdDate`;
