...
CREATE TABLE `teeme_leaf_meta` ( `id` INT NOT NULL AUTO_INCREMENT , `leaf_id` INT NOT NULL , `meta_key` VARCHAR(512) NOT NULL , `meta_value` VARCHAR(512) NOT NULL , PRIMARY KEY (`id`)) ENGINE = InnoDB DEFAULT CHARSET=utf8 COLLATE utf8_unicode_ci; 
